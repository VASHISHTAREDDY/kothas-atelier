...
a.options.vertical===!1&&a.options.variableWidth===!1?(a.slideWidth=Math.ceil(a.listWidth/a.options.slidesToShow),a.$slideTrack.width(Math.ceil(a.slideWidth*a.$slideTrack.children(".slick-slide").length))):a.options.variableWidth===!0?a.$slideTrack.width(5e3*a.slideCount):(a.slideWidth=Math.ceil(a.listWidth),a.$slideTrack.height(Math.ceil(a.$slides.first().outerHeight(!0)*a.$slideTrack.children(".slick-slide").length)));var b=a.$slides.first().outerWidth(!0)-a.$slides.first().width();a.options.variableWidth===!1&&a.$slideTrack.children(".slick-slide").width(a.slideWidth-b)},b.prototype.setFade=function(){var b,c=this;c.$slides.each(function(d,e){b=c.slideWidth*d*-1,c.options.rtl===!0?a(e).css({position:"relative",right:b,top:0,zIndex:c.options.zIndex-2,opacity:0}):a(e).css({position:"relative",left:b,top:0,zIndex:c.options.zIndex-2,opacity:0})}),c.$slides.eq(c.currentSlide).css({zIndex:c.options.zIndex-1,opacity:1})},b.prototype.setHeight=function(){var a=this;if(1===a.options.slidesToShow&&a.options.adaptiveHeight===!0&&a.options.vertical===!1){var b=a.$slides.eq(a.currentSlide).outerHeight(!0);a.$list.css("height",b)}},b.prototype.setOption=b.prototype.slickSetOption=function(){var b,c,d,e,f,g=this,h=!1;if("object"===a.type(arguments[0])?(d=arguments[0],h=arguments[1],f="multiple"):"string"===a.type(arguments[0])&&(d=arguments[0],e=arguments[1],h=arguments[2],"responsive"===arguments[0]&&"array"===a.type(arguments[1])?f="responsive":"undefined"!=typeof arguments[1]&&(f="single")),"single"===f)g.options[d]=e;else if("multiple"===f)a.each(d,function(a,b){g.options[a]=b});else if("responsive"===f)for(c in e)if("array"!==a.type(g.options.responsive))g.options.responsive=[e[c]];else{for(b=g.options.responsive.length-1;b>=0;)g.options.responsive[b].breakpoint===e[c].breakpoint&&g.options.responsive.splice(b,1),b--;g.options.responsive.push(e[c])}h&&(g.unload(),g.reinit())},b.prototype.setPosition=function(){var a=this;a.setDimensions(),a.setHeight(),a.options.fade===!1?a.setCSS(a.getLeft(a.currentSlide)):a.setFade(),a.$slider.trigger("setPosition",[a])},b.prototype.setProps=function(){var a=this,b=document.body.style;a.positionProp=a.options.vertical===!0?"top":"left","top"===a.positionProp?a.$slider.addClass("slick-vertical"):a.$slider.removeClass("slick-vertical"),void 0===b.WebkitTransition&&void 0===b.MozTransition&&void 0===b.msTransition||a.options.useCSS===!0&&(a.cssTransitions=!0),a.options.fade&&("number"==typeof a.options.zIndex?a.options.zIndex<3&&(a.options.zIndex=3):a.options.zIndex=a.defaults.zIndex),void 0!==b.OTransform&&(a.animType="OTransform",a.transformType="-o-transform",a.transitionType="OTransition",void 0===b.perspectiveProperty&&void 0===b.webkitPerspective&&(a.animType=!1)),void 0!==b.MozTransform&&(a.animType="MozTransform",a.transformType="-moz-transform",a.transitionType="MozTransition",void 0===b.perspectiveProperty&&void 0===b.MozPerspective&&(a.animType=!1)),void 0!==b.webkitTransform&&(a.animType="webkitTransform",a.transformType="-webkit-transform",a.transitionType="webkitTransition",void 0===b.perspectiveProperty&&void 0===b.webkitPerspective&&(a.animType=!1)),void 0!==b.msTransform&&(a.animType="msTransform",a.transformType="-ms-transform",a.transitionType="msTransition",void 0===b.msTransform&&(a.animType=!1)),void 0!==b.transform&&a.animType!==!1&&(a.animType="transform",a.transformType="transform",a.transitionType="transition"),a.transformsEnabled=a.options.useTransform&&null!==a.animType&&a.animType!==!1},b.prototype.setSlideClasses=function(a){var b,c,d,e,f=this;if(c=f.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden","true"),f.$slides.eq(a).addClass("slick-current"),f.options.centerMode===!0){var g=f.options.slidesToShow%2===0?1:0;b=Math.floor(f.options.slidesToShow/2),f.options.infinite===!0&&(a>=b&&a<=f.slideCount-1-b?f.$slides.slice(a-b+g,a+b+1).addClass("slick-active").attr("aria-hidden","false"):(d=f.options.slidesToShow+a,c.slice(d-b+1+g,d+b+2).addClass("slick-active").attr("aria-hidden","false")),0===a?c.eq(c.length-1-f.options.slidesToShow).addClass("slick-center"):a===f.slideCount-1&&c.eq(f.options.slidesToShow).addClass("slick-center")),f.$slides.eq(a).addClass("slick-center")}else a>=0&&a<=f.slideCount-f.options.slidesToShow?f.$slides.slice(a,a+f.options.slidesToShow).addClass("slick-active").attr("aria-hidden","false"):c.length<=f.options.slidesToShow?c.addClass("slick-active").attr("aria-hidden","false"):(e=f.slideCount%f.options.slidesToShow,d=f.options.infinite===!0?f.options.slidesToShow+a:a,f.options.slidesToShow==f.options.slidesToScroll&&f.slideCount-a<f.options.slidesToShow?c.slice(d-(f.options.slidesToShow-e),d+e).addClass("slick-active").attr("aria-hidden","false"):c.slice(d,d+f.options.slidesToShow).addClass("slick-active").attr("aria-hidden","false"));"ondemand"!==f.options.lazyLoad&&"anticipated"!==f.options.lazyLoad||f.lazyLoad()},b.prototype.setupInfinite=function(){var b,c,d,e=this;if(e.options.fade===!0&&(e.options.centerMode=!1),e.options.infinite===!0&&e.options.fade===!1&&(c=null,e.slideCount>e.options.slidesToShow)){for(d=e.options.centerMode===!0?e.options.slidesToShow+1:e.options.slidesToShow,b=e.slideCount;b>e.slideCount-d;b-=1)c=b-1,a(e.$slides[c]).clone(!0).attr("id","").attr("data-slick-index",c-e.slideCount).prependTo(e.$slideTrack).addClass("slick-cloned");for(b=0;b<d+e.slideCount;b+=1)c=b,a(e.$slides[c]).clone(!0).attr("id","").attr("data-slick-index",c+e.slideCount).appendTo(e.$slideTrack).addClass("slick-cloned");e.$slideTrack.find(".slick-cloned").find("[id]").each(function(){a(this).attr("id","")})}},b.prototype.interrupt=function(a){var b=this;a||b.autoPlay(),b.interrupted=a},b.prototype.selectHandler=function(b){var c=this,d=a(b.target).is(".slick-slide")?a(b.target):a(b.target).parents(".slick-slide"),e=parseInt(d.attr("data-slick-index"));return e||(e=0),c.slideCount<=c.options.slidesToShow?void c.slideHandler(e,!1,!0):void c.slideHandler(e)},b.prototype.slideHandler=function(a,b,c){var d,e,f,g,h,i=null,j=this;if(b=b||!1,!(j.animating===!0&&j.options.waitForAnimate===!0||j.options.fade===!0&&j.currentSlide===a))return b===!1&&j.asNavFor(a),d=a,i=j.getLeft(d),g=j.getLeft(j.currentSlide),j.currentLeft=null===j.swipeLeft?g:j.swipeLeft,j.options.infinite===!1&&j.options.centerMode===!1&&(a<0||a>j.getDotCount()*j.options.slidesToScroll)?void(j.options.fade===!1&&(d=j.currentSlide,c!==!0?j.animateSlide(g,function(){j.postSlide(d)}):j.postSlide(d))):j.options.infinite===!1&&j.options.centerMode===!0&&(a<0||a>j.slideCount-j.options.slidesToScroll)?void(j.options.fade===!1&&(d=j.currentSlide,c!==!0?j.animateSlide(g,function(){j.postSlide(d)}):j.postSlide(d))):(j.options.autoplay&&clearInterval(j.autoPlayTimer),e=d<0?j.slideCount%j.options.slidesToScroll!==0?j.slideCount-j.slideCount%j.options.slidesToScroll:j.slideCount+d:d>=j.slideCount?j.slideCount%j.options.slidesToScroll!==0?0:d-j.slideCount:d,j.animating=!0,j.$slider.trigger("beforeChange",[j,j.currentSlide,e]),f=j.currentSlide,j.currentSlide=e,j.setSlideClasses(j.currentSlide),j.options.asNavFor&&(h=j.getNavTarget(),h=h.slick("getSlick"),h.slideCount<=h.options.slidesToShow&&h.setSlideClasses(j.currentSlide)),j.updateDots(),j.updateArrows(),j.options.fade===!0?(c!==!0?(j.fadeSlideOut(f),j.fadeSlide(e,function(){j.postSlide(e)})):j.postSlide(e),void j.animateHeight()):void(c!==!0?j.animateSlide(i,function(){j.postSlide(e)}):j.postSlide(e)))},b.prototype.startLoad=function(){var a=this;a.options.arrows===!0&&a.slideCount>a.options.slidesToShow&&(a.$prevArrow.hide(),a.$nextArrow.hide()),a.options.dots===!0&&a.slideCount>a.options.slidesToShow&&a.$dots.hide(),a.$slider.addClass("slick-loading")},b.prototype.swipeDirection=function(){var a,b,c,d,e=this;return a=e.touchObject.startX-e.touchObject.curX,b=e.touchObject.startY-e.touchObject.curY,c=Math.atan2(b,a),d=Math.round(180*c/Math.PI),d<0&&(d=360-Math.abs(d)),d<=45&&d>=0?e.options.rtl===!1?"left":"right":d<=360&&d>=315?e.options.rtl===!1?"left":"right":d>=135&&d<=225?e.options.rtl===!1?"right":"left":e.options.verticalSwiping===!0?d>=35&&d<=135?"down":"up":"vertical"},b.prototype.swipeEnd=function(a){var b,c,d=this;if(d.dragging=!1,d.swiping=!1,d.scrolling)return d.scrolling=!1,!1;if(d.interrupted=!1,d.shouldClick=!(d.touchObject.swipeLength>10),void 0===d.touchObject.curX)return!1;if(d.touchObject.edgeHit===!0&&d.$slider.trigger("edge",[d,d.swipeDirection()]),d.touchObject.swipeLength>=d.touchObject.minSwipe){switch(c=d.swipeDirection()){case"left":case"down":b=d.options.swipeToSlide?d.checkNavigable(d.currentSlide+d.getSlideCount()):d.currentSlide+d.getSlideCount(),d.currentDirection=0;break;case"right":case"up":b=d.options.swipeToSlide?d.checkNavigable(d.currentSlide-d.getSlideCount()):d.currentSlide-d.getSlideCount(),d.currentDirection=1}"vertical"!=c&&(d.slideHandler(b),d.touchObject={},d.$slider.trigger("swipe",[d,c]))}else d.touchObject.startX!==d.touchObject.curX&&(d.slideHandler(d.currentSlide),d.touchObject={})},b.prototype.swipeHandler=function(a){var b=this;if(!(b.options.swipe===!1||"ontouchend"in document&&b.options.swipe===!1||b.options.draggable===!1&&a.type.indexOf("mouse")!==-1))switch(b.touchObject.fingerCount=a.originalEvent&&void 0!==a.originalEvent.touches?a.originalEvent.touches.length:1,b.touchObject.minSwipe=b.listWidth/b.options.touchThreshold,b.options.verticalSwiping===!0&&(b.touchObject.minSwipe=b.listHeight/b.options.touchThreshold),a.data.action){case"start":b.swipeStart(a);break;case"move":b.swipeMove(a);break;case"end":b.swipeEnd(a)}},b.prototype.swipeMove=function(a){var b,c,d,e,f,g,h=this;return f=void 0!==a.originalEvent?a.originalEvent.touches:null,!(!h.dragging||h.scrolling||f&&1!==f.length)&&(b=h.getLeft(h.currentSlide),h.touchObject.curX=void 0!==f?f[0].pageX:a.clientX,h.touchObject.curY=void 0!==f?f[0].pageY:a.clientY,h.touchObject.swipeLength=Math.round(Math.sqrt(Math.pow(h.touchObject.curX-h.touchObject.startX,2))),g=Math.round(Math.sqrt(Math.pow(h.touchObject.curY-h.touchObject.startY,2))),!h.options.verticalSwiping&&!h.swiping&&g>4?(h.scrolling=!0,!1):(h.options.verticalSwiping===!0&&(h.touchObject.swipeLength=g),c=h.swipeDirection(),void 0!==a.originalEvent&&h.touchObject.swipeLength>4&&(h.swiping=!0,a.preventDefault()),e=(h.options.rtl===!1?1:-1)*(h.touchObject.curX>h.touchObject.startX?1:-1),h.options.verticalSwiping===!0&&(e=h.touchObject.curY>h.touchObject.startY?1:-1),d=h.touchObject.swipeLength,h.touchObject.edgeHit=!1,h.options.infinite===!1&&(0===h.currentSlide&&"right"===c||h.currentSlide>=h.getDotCount()&&"left"===c)&&(d=h.touchObject.swipeLength*h.options.edgeFriction,h.touchObject.edgeHit=!0),h.options.vertical===!1?h.swipeLeft=b+d*e:h.swipeLeft=b+d*(h.$list.height()/h.listWidth)*e,h.options.verticalSwiping===!0&&(h.swipeLeft=b+d*e),h.options.fade!==!0&&h.options.touchMove!==!1&&(h.animating===!0?(h.swipeLeft=null,!1):void h.setCSS(h.swipeLeft))))},b.prototype.swipeStart=function(a){var b,c=this;return c.interrupted=!0,1!==c.touchObject.fingerCount||c.slideCount<=c.options.slidesToShow?(c.touchObject={},!1):(void 0!==a.originalEvent&&void 0!==a.originalEvent.touches&&(b=a.originalEvent.touches[0]),c.touchObject.startX=c.touchObject.curX=void 0!==b?b.pageX:a.clientX,c.touchObject.startY=c.touchObject.curY=void 0!==b?b.pageY:a.clientY,void(c.dragging=!0))},b.prototype.unfilterSlides=b.prototype.slickUnfilter=function(){var a=this;null!==a.$slidesCache&&(a.unload(),a.$slideTrack.children(this.options.slide).detach(),a.$slidesCache.appendTo(a.$slideTrack),a.reinit())},b.prototype.unload=function(){var b=this;a(".slick-cloned",b.$slider).remove(),b.$dots&&b.$dots.remove(),b.$prevArrow&&b.htmlExpr.test(b.options.prevArrow)&&b.$prevArrow.remove(),b.$nextArrow&&b.htmlExpr.test(b.options.nextArrow)&&b.$nextArrow.remove(),b.$slides.removeClass("slick-slide slick-active slick-visible slick-current").attr("aria-hidden","true").css("width","")},b.prototype.unslick=function(a){var b=this;b.$slider.trigger("unslick",[b,a]),b.destroy()},b.prototype.updateArrows=function(){var a,b=this;a=Math.floor(b.options.slidesToShow/2),b.options.arrows===!0&&b.slideCount>b.options.slidesToShow&&!b.options.infinite&&(b.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false"),b.$nextArrow.removeClass("slick-disabled").attr("aria-disabled","false"),0===b.currentSlide?(b.$prevArrow.addClass("slick-disabled").attr("aria-disabled","true"),b.$nextArrow.removeClass("slick-disabled").attr("aria-disabled","false")):b.currentSlide>=b.slideCount-b.options.slidesToShow&&b.options.centerMode===!1?(b.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),b.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")):b.currentSlide>=b.slideCount-1&&b.options.centerMode===!0&&(b.$nextArrow.addClass("slick-disabled").attr("aria-disabled","true"),b.$prevArrow.removeClass("slick-disabled").attr("aria-disabled","false")))},b.prototype.updateDots=function(){var a=this;null!==a.$dots&&(a.$dots.find("li").removeClass("slick-active").end(),a.$dots.find("li").eq(Math.floor(a.currentSlide/a.options.slidesToScroll)).addClass("slick-active"))},b.prototype.visibility=function(){var a=this;a.options.autoplay&&(document[a.hidden]?a.interrupted=!0:a.interrupted=!1)},a.fn.slick=function(){var a,c,d=this,e=arguments[0],f=Array.prototype.slice.call(arguments,1),g=d.length;for(a=0;a<g;a++)if("object"==typeof e||"undefined"==typeof e?d[a].slick=new b(d[a],e):c=d[a].slick[e].apply(d[a].slick,f),"undefined"!=typeof c)return c;return d}});var $window=$(window),$document=$(document),$body=$("body"),$html=$("html"),$navBar=$("#desktop-nav"),pnpHelper={},navHeights={xs:57,sm:65,md:73,lg:81,xlg:96};pnpHelper.bootstrap={xs:768,md:992,lg:1200,xlg:1500,ipadLanscape:1024,ipadPortrait:768,isXs:function(){return $window.outerWidth()<pnpHelper.bootstrap.xs},isSm:function(){return $window.outerWidth()>=pnpHelper.bootstrap.xs},isMd:function(){return $window.outerWidth()>=pnpHelper.bootstrap.md},isLg:function(){return $window.outerWidth()>=pnpHelper.bootstrap.lg},isXlg:function(){return $window.outerWidth()>=pnpHelper.bootstrap.xlg}},pnpHelper.getNavHeight=function(){return pnpHelper.bootstrap.isXlg()?navHeights.xlg:pnpHelper.bootstrap.isLg()?navHeights.lg:pnpHelper.bootstrap.isMd()?navHeights.md:pnpHelper.bootstrap.isSm()?navHeights.sm:0},pnpHelper.onResizeFinished=function(a,b){var c;$window.on("resize",function(b){clearTimeout(c),c=setTimeout(a,50)}),b&&a.call()},pnpHelper.scroll={scrollPast:function(a,b){if(b)var c=b;else var c=$(a);var d=c.offset().top+c.outerHeight(!0)-pnpHelper.getNavHeight();pnpHelper.scroll.doScroll(d)},scrollTo:function(a,b,c){var d=$(a).offset().top;d-=pnpHelper.getNavHeight(),c&&(d-=c),pnpHelper.scroll.doScroll(d,b)},doScroll:function(a,b){b||(b=null),a&&$("html,body").animate({scrollTop:a},500,b)}},pnpHelper.preloadImage=function(a){Log.info("Preloading image: "+a);var b=new Image;b.src=a},pnpHelper.dependencyCheck={fixTo:"fixTo",viewportChecker:"viewportChecker",jqueryCookie:"jqueryCookie",slickSlider:"slickSlider",hoverIntent:"hoverIntent",bootstrapModal:"bootstrapModal",fullPageJs:"fullPageJs",requireDependencies:function(a,b){function c(b){console.error("MISSING DEPENDENCY: The component '"+a+"' requires the JS library '"+b+"'. Please add it to the project."),d=!0}if(b&&b.length){var d=!1;for(var e in b){var f=b[e];f===pnpHelper.dependencyCheck.fixTo?window.fixto||c(f):f===pnpHelper.dependencyCheck.viewportChecker?$.fn.viewportChecker||c(f):f===pnpHelper.dependencyCheck.jqueryCookie?$.cookie||c(f):f===pnpHelper.dependencyCheck.slickSlider?$.fn.slick||c(f):f===pnpHelper.dependencyCheck.hoverIntent?$.fn.hoverIntent||c(f):f===pnpHelper.dependencyCheck.bootstrapModal?$.fn.modal||c(f):f===pnpHelper.dependencyCheck.fullPageJs?$.fn.fullpage||c(f):console.warn("A check for dependency '"+f+"' was not found.")}return d}return console.warn("No dependencies passed to dependencyCheck.requireDependencies() function"),!1}},pnpHelper.browser={isFirefox:!1,isChrome:!1,isSafari:!1,isIOS:!1,isIE:!1,version:{ie:!1,ios:!1}},doBrowserCheck(!1),function(){var a=function(){};window.console||(window.console={log:a,info:a,warn:a,debug:a,error:a})}();var touch=Modernizr.prefixed("MaxTouchPoints",navigator);if(!Modernizr.touch&&(touch||navigator.maxTouchPoints&&navigator.maxTouchPoints>0)&&(Modernizr.touch=!0,$html.addClass("touch").removeClass("no-touch")),pnpHelper.ajaxNavigation=function(){var a=[];this.loadPage=function(b,c,d){function e(a){c&&(a?(window.history.pushState&&window.history.pushState(a,a.title,b),$("#content > article").height($("#content > article").outerHeight()),$("#content > article").html(a.html),$("title").text(a.title),$("#content > article").height("auto"),$.pnp.initPage()):console.error("A valid page cannot be found for URL "+thisSlideUrl,a)),d&&d(a)}a[b]?(console.log("Returning page from cache"),e(a[b])):(console.log("Returning page"),$.get(b,function(c){var d=$(c).find("#content > article").html(),f=$(c).filter("title").text();a[b]={html:d,title:f},e(a[b])}))}},pnpHelper.modal={open:function(a){var b=0,c=0;$(a).on("shown.bs.modal",function(b){$.pnp.initPage(),wpcf7.initForm($(a).find(".wpcf7 > form"))}).on("show.bs.modal",function(){b=$("body").css("top"),c=$("body").scrollTop(),$body.css({top:-c})}).on("hidden.bs.modal",function(){$body.css({top:b}),$body.scrollTop(c)}).modal()}},function(a){a.pnp={},a.pnp.initPlaceholderShim=function(){a.placeholder.shim()},a.pnp.initSelectric=function(){a('select:not(".-unstyled")').selectric({onChange:function(){0===a(this).val().length?(a(this).addClass("placeholder"),a(this).selectric("refresh")):(a(this).removeClass("placeholder"),a(this).selectric("refresh"))},onClose:function(){"select_required"===a(this).attr("data-validation")&&(0===a(this).val().length?(a(this).closest(".selectric-wrapper").find(".selectric").addClass("error").removeClass("valid"),a(this).closest(".form-group").hasClass("has-error")||a(this).closest(".form-group").addClass("has-error").append('<span class="help-block form-error">This is a required field</span>')):(a(this).closest(".selectric-wrapper").find(".selectric").addClass("valid").removeClass("error"),a(this).closest(".has-error").removeClass("has-error").find(".form-error").remove()))}})},a.pnp.initDatePicker=function(){a(".datepicker").each(function(){var b=new Date;b.setDate(b.getDate()+1),"future"==a(this).data("pnp-pikaday-config")?new Pikaday({field:a(this)[0],format:"DD/MM/YYYY",minDate:b}):new Pikaday({field:a(this)[0],format:"DD/MM/YYYY"})})},a.pnp.initFormValidation=function(){a.validate({modules:"uk, date, security",scrollToTopOnError:!1,onValidate:function(b){var c=[];return b.find('select[data-validation="pnp_select_required"]:hidden').each(function(){0===a(this).val().length?(c.push({element:a(this),message:"This is a required field"}),a(this).closest(".selectric-wrapper").find(".selectric").addClass("error").removeClass("valid")):a(this).closest(".selectric-wrapper").find(".selectric").removeClass("error").addClass("valid")}),0===c.length||c}}),$document.on("click","[data-pnp-validate-postcode]",function(){var b=a(this);return a(a(this).data("pnp-validate-postcode")).validate(function(c,d){c&&a(b.data("pnp-show-postcode")).slideDown()}),!1})},a.pnp.initFixto=function(){a("[data-pnp-fixto], [data-pnp-fixto-parent]").length&&(a("[data-pnp-fixto]").fixTo("body",{top:pnpHelper.getNavHeight()}),a("[data-pnp-fixto-parent]").each(function(){a(this).fixTo(a(this).parent(),{})}))},a.pnp.initDropdowns=function(){a(".dropdown").dropdown()},a.pnp.initScrollHijack=function(){if($body.hasClass("page-template-tpl-one-page-scroll-php")){if(pnpHelper.dependencyCheck.requireDependencies("Scroll Hijack",[pnpHelper.dependencyCheck.fullPageJs]))return;pnpHelper.bootstrap.isSm()&&a(".fullpage-section").length>1&&a("#content > article").fullpage({scrollBar:!0,scrollingSpeed:1e3,navigation:!0,responsiveWidth:768,navigationPosition:"right",fixedElements:"#page-header",fadingEffect:!0,fadingEffectKey:"_",sectionSelector:".fullpage-section",slideSelector:".fullpage-slide"})}};var b={37:1,38:1,39:1,40:1};a.pnp.preventDefault=function(a){a=a||window.event,a.preventDefault&&a.preventDefault(),a.returnValue=!1},a.pnp.preventDefaultForScrollKeys=function(c){if(b[c.keyCode])return a.pnp.preventDefault(c),!1},a.pnp.disableScroll=function(){window.addEventListener&&window.addEventListener("DOMMouseScroll",a.pnp.preventDefault,!1),window.onwheel=a.pnp.preventDefault,window.onmousewheel=document.onmousewheel=a.pnp.preventDefault,window.ontouchmove=a.pnp.preventDefault,document.onkeydown=a.pnp.preventDefaultForScrollKeys},a.pnp.enableScroll=function(){window.removeEventListener&&window.removeEventListener("DOMMouseScroll",a.pnp.preventDefault,!1),window.onmousewheel=document.onmousewheel=null,window.onwheel=null,window.ontouchmove=null,document.onkeydown=null},a.pnp.initHeaderBanner=function(){var b=a(".component-header-banner");b.length&&b.each(function(){a(".slider-nav").css("display","none");var b=a(this);b.find(".caption").css({display:"block"});var c=a(this).find("h4").text();a(".project>.case").html(c),b.find(".caption button").append('<div class="left">'),b.find(".caption button").append('<div class="top">'),b.find(".caption button").append('<div class="right">'),b.find(".caption button").append('<div class="bottom">'),TweenMax.from(".caption .inner .subtitle",1,{autoAlpha:0,delay:.4,ease:Cubic.easeOut}),TweenMax.from(".caption .inner h4",2,{autoAlpha:0,delay:.5,ease:Cubic.easeOut}),TweenMax.from(".shader",1,{autoAlpha:0,delay:.5,ease:Cubic.easeOut});var d=a(this).find(".background"),e=d.attr("data-video"),f=d.attr("data-poster");if(""!==e&&void 0!==e&&a(this).find(".background").vide({mp4:e,poster:f},{volume:0,playbackRate:1,muted:!0,loop:!0,autoplay:!1,position:"0% 50%",posterType:"jpg",resizing:!0,bgColor:"#000000",className:""}),b.find("p").length){var g=new SplitText(b.find("p"),{type:"chars,words,lines",position:"absolute"});b.find(".caption button").css("visibility","hidden"),b.find(".caption button").removeClass("in"),TweenMax.staggerFrom(g.words,2,{autoAlpha:0,ease:Cubic.easeOut,delay:1,onStart:function(){void 0!==b.find(".background").data("vide")&&b.find(".background").data("vide").getVideoObject().play()},onComplete:function(){b.find(".caption button, .caption button span").css("visibility","visible").addClass("in")}},.05),a(".caption button").click(function(e){if(e)e.preventDefault();var d=a(window).width()<767?(window.headHeight-57):window.headHeight;a("html,body").stop().animate({scrollTop:d},700);TweenMax.to(window,.7,{scrollTo:{y:d,autoKill:!1},ease:Cubic.easeInOut})})}else setTimeout(function(){void 0!==b.find(".background").data("vide")&&b.find(".background").data("vide").getVideoObject().play()},300)})},a.pnp.initStackedLayers=function(){var b=a(".component-stacked-layers");b.length&&b.each(function(){a(this).find(".stacked").each(function(b){a(this).fixTo(a(this).parent(),{})})})},a.pnp.triggeredFromFooter=!1,a.pnp.currentTarget="",a.pnp.initColouredText=function(){var b=a(".component-coloured-text");b.length&&b.each(function(){var b=a(this);b.hasClass("checked")||(b.viewportChecker({callbackFunction:function(a,c){var d=b.attr("data-txt-colour"),e=b.attr("data-bg-colour");TweenMax.to(b,2,{backgroundColor:e,delay:.5,ease:Cubic.easeInOut}),TweenMax.to(b.find(".inner"),2,{color:d,delay:.5,ease:Cubic.easeInOut})}}),b.addClass("checked"))})},a.pnp.initScrollMagic=function(){function b(){var b=a(".slider-nav"),d=new TimelineMax;d.add(TweenMax.to(b.find(".caption"),2,{alpha:0,y:-10,ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerHook:"onLeave",duration:.6*b.height()}).setTween(d).addTo(c).on("enter leave",function(b){"enter"==b.type?(TweenMax.to(a(".nav-container .project"),.5,{alpha:0}),a(".nav-container").hasClass("white")||a(".nav-container").addClass("white"),a(".nav-container").hasClass("black")&&a(".nav-container").removeClass("black")):TweenMax.to(a(".nav-container .project"),.5,{alpha:1})})}window.controller=new ScrollMagic.Controller,window.scenes=[];var c=window.controller,d=a(".layout").length-1;a(".layout").each(function(b){function e(b){if(a(window).width()>767)switch(f.attr("data-header")){case"white":a(".nav-container").hasClass("white")||a(".nav-container").addClass("white"),a(".nav-container").hasClass("black")&&a(".nav-container").removeClass("black");break;case"black":a(".nav-container").hasClass("white")&&a(".nav-container").removeClass("white"),a(".nav-container").hasClass("black")||a(".nav-container").addClass("black")}}var f=a(this),g="mm-"+b,h=f.find(".component"),i=!1;f.attr("id",g),b===d&&f.addClass("last-layout"),h.each(function(d){var h=a(this).attr("class").split(" ")[1],j=a(this),k=new ScrollMagic.Scene({triggerHook:"onLeave",triggerElement:"#"+g,duration:f.height()}).addTo(c).on("enter leave",function(a){e(a.type)});switch(i&&k.addIndicators({name:"layout-"+b}),window.scenes.push(k),h){case"slider-nav":var l=new TimelineMax;l.add(TweenMax.to(f.find(".caption"),2,{alpha:0,y:-10,ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerHook:"onLeave",triggerElement:"#"+g,duration:.6*f.height()}).setTween(l).addTo(c).on("enter leave",function(b){"enter"==b.type?TweenMax.to(a(".nav-container .project"),.5,{alpha:0}):TweenMax.to(a(".nav-container .project"),.5,{alpha:1})});break;case"component-header-banner":var l=new TimelineMax;l.add(TweenMax.to(f.find(".caption"),2,{alpha:0,y:-10,ease:Linear.easeNone}),0);new ScrollMagic.Scene({triggerHook:"onLeave",triggerElement:"#"+g,duration:.6*f.height()}).setTween(l).addTo(c).on("enter leave",function(b){"enter"==b.type?TweenMax.to(a(".nav-container .project"),.5,{alpha:0}):TweenMax.to(a(".nav-container .project"),.5,{alpha:1})});break;case"component-full-bleed-image":var l=new TimelineMax,m="1"===j.attr("data-parallax");"reveal"===j.attr("data-transition")?(l.add(TweenMax.fromTo(f.find(".image-mask .left, .image-mask .right"),2,{width:"40%",ease:Linear.easeNone},{width:0}),0),m&&l.add(TweenMax.from(f.find(".image-container"),2,{y:"-20%",ease:Linear.easeNone}),0)):(l.add(TweenMax.from(f.find(".image-mask"),2,{x:"-30%",ease:Linear.easeNone}),0),m?l.add(TweenMax.from(f.find(".image-container"),2,{x:"30%",y:"-20%",ease:Linear.easeNone}),0):l.add(TweenMax.from(f.find(".image-container"),2,{x:"30%",ease:Linear.easeNone}),0));new ScrollMagic.Scene({triggerHook:"onEnter",triggerElement:"#"+g,duration:f.height()}).setTween(l).addTo(c);break;case"component-parallax-image":var l=new TimelineMax;l.add(TweenMax.from(a(this).find(".image"),2,{y:"-20%",ease:Linear.easeNone,force3D:!0}),0);new ScrollMagic.Scene({triggerHook:"onEnter",triggerElement:"#"+g,duration:"200%"}).setTween(l).addTo(c);break;case"component-coloured-text":if(j.hasClass("lined")){var l=new TimelineMax;l.add(TweenMax.from(j.find(".line"),1,{delay:1,scaleY:0,transformOrigin:"top left",ease:Linear.easeNone,force3D:"auto"}),0);new ScrollMagic.Scene({triggerHook:"onEnter",triggerElement:"#"+g,duration:f.height()}).setTween(l).addTo(c)}break;case"component-process":var l=new TimelineMax({delay:0});j.find(".steps>li").each(function(b){var c=a(this);c.attr("id","step-"+b),l.add(TweenMax.to(c.find(".number"),1,{autoAlpha:.4,ease:Cubic.easeOut})),c.find(".section-title").length&&l.add(TweenMax.to(c.find(".section-title"),1,{autoAlpha:1,x:0,ease:Cubic.easeOut})),l.add(TweenMax.from(c.find(".line"),1,{scaleY:0,transformOrigin:"top left",ease:Linear.easeNone,force3D:"auto"})).add(TweenMax.to(c.find(".title"),1,{autoAlpha:.8,x:0,ease:Cubic.easeOut}),"-=0.5").add(TweenMax.to(c.find(".description"),1,{autoAlpha:.7,x:0,ease:Cubic.easeOut}),"-=0.5")});new ScrollMagic.Scene({triggerHook:.75,triggerElement:"#"+g,duration:f.height()}).setTween(l).addTo(c)}})}),b()},a.pnp.initViewportChecker=function(){if(!Modernizr.touch){if(!a.fn.viewportChecker)return void console.error("MISSING DEPENDANCY: The component 'animate-on-scroll' requires the library 'jquery-viewport-checker'. Please update packages.json to include this library.");a("[data-pnp-animation-delay]").each(function(){a(this).css("animation-delay",a(this).data("pnp-animation-delay"))}),a("[data-pnp-animation-duration]").each(function(){a(this).css("animation-duration",a(this).data("pnp-animation-duration"))}),a("[data-pnp-animate]").each(function(){a(this).addClass("aos-transparent").viewportChecker({classToAdd:"aos-not-transparent animated "+a(this).data("pnp-animate"),offset:"10%",invertBottomOffset:!0})})}},a.pnp.initZoomhandler=function(){var a=(window.outerWidth-8)/window.innerWidth,b=null;b=a>=.46&&a<=.54?"-4":a<=.64?"-3":a<=.76?"-2":a<=.92?"-1":a<=1.1?"0":a<=1.32?"1":a<=1.58?"2":a<=1.9?"3":a<=2.28?"4":a<=2.7?"5":"unknown"},a.pnp.responsiveImages=function(){var b=a(window).width()<768;a(".background").each(function(){var c=a(this),d=c.attr("data-mobile");b&&void 0!==d&&c.css("background-image","url("+d+")")})},a.pnp.initSmoothstate=function(){var b=a("#content");b.wrapInner('<div class="old-content">'),a(".smoothstate").length&&b.smoothState({debug:!0,anchors:".smoothstate a, .smoothstate button",blacklist:"form, .no-smoothState, .wpcf7-form",forms:"form",prefetch:!0,prefetchOn:"aim",scroll:!1,loadingClass:"",onBefore:function(a,b){},onStart:{duration:350,render:function(b){null!==window.countDown&&void 0!==window.countDown&&(window.countDown.pause(),window.countDown.seek(0));var c=a(".component-expanding-cta");c.addClass("clicked"),a(".nav-container").hasClass("white")||a(".nav-container").addClass("white"),a(".nav-container").hasClass("black")&&a(".nav-container").removeClass("black"),TweenMax.to(a(".nav-container .project"),.5,{auto:0}),a.pnp.triggeredFromFooter&&TweenMax.to(c.find("a"),.35,{height:"100vh",ease:Cubic.easeInOut,onStart:function(){if(a(".slider-nav").length&&(a(".nav-container").hasClass("black")&&a(".nav-container").removeClass("black"),a(".slider-nav ul li").each(function(b){var c=a(this),d=c.find(".inner").attr("data-link");if(a.pnp.currentTarget.indexOf(d)>-1&&"http://mm.test"!==d&&"http://minaleandmannnew.pnpd.co.uk"!==d&&"https://minaleandmannnew.pnpd.co.uk"!==d){var e=a(".slider-nav>.slider-wrapper>.slides"),f=e.data("flickity");f.select(b,!1,!0);var g=a(".slider-nav .captions-full ul"),h=g.data("flickity");h.select(b,!1,!0)}})),window.scenes.length>0){for(var b=0;b<window.scenes.length;b++)window.scenes[b].destroy(!0),window.scenes[b]=null;window.controller.destroy(!0),window.controller=null}}})}},onReady:{duration:10,render:function(b,c){if(b.append(c),a.pnp.triggeredFromFooter)a(".slider-nav").length&&(a(".slider-nav").css("display","block"),a(".captions-full, .captions-full .caption").css("visibility","hidden"),a(".captions-full .caption .loadpage").css("visibility","hidden").removeClass("in"),TweenMax.set(a(".captions-full"),{autoAlpha:0}),TweenMax.set(a(".captions-full .is-selected").find("h4"),{autoAlpha:0}),TweenMax.set(a(".captions-full .is-selected").find(".subtitle"),{autoAlpha:0}),TweenMax.set(a(".captions-full .is-selected").find("p"),{autoAlpha:0}),a(window).width()<767&&TweenMax.set(a(".captions-full .is-selected").find(".seo-title"),{autoAlpha:0}),TweenMax.set(a(".captions-full .is-selected").find("p"),{autoAlpha:0}),setTimeout(function(){a(".nav-container").hasClass("black")&&a(".nav-container").removeClass("black"),a(".captions-full, .captions-full .caption").css("visibility","visible"),TweenMax.to(a(".captions-full"),.5,{autoAlpha:1,onComplete:function(){window.zoomEffect(),TweenMax.to(".arrow",.5,{delay:1,autoAlpha:1}),TweenMax.to(a(".captions-full .is-selected").find(".subtitle"),1,{autoAlpha:1,delay:.1,ease:Cubic.easeOut}),TweenMax.to(a(".captions-full .is-selected").find("h4"),5,{autoAlpha:1,delay:.5,ease:Cubic.easeOut}),a(window).width()<767&&TweenMax.to(a(".captions-full .is-selected").find(".seo-title"),1,{autoAlpha:.5,delay:.7}),TweenMax.set(a(".captions-full .is-selected").find("p"),{autoAlpha:1});var b=new SplitText(a(".captions-full .is-selected").find("p"),{type:"chars,words,lines"});TweenMax.staggerFrom(b.words,2,{autoAlpha:0,ease:Cubic.easeOut,delay:.5,onStart:function(){a(".captions-full .is-selected .caption").css("visibility","visible");
},onComplete:function(){a(".captions-full .is-selected .caption").find(".loadpage").css("visibility","visible").addClass("in")}},.04),a(".project .case").html(a(".captions-full li.is-selected .inner .caption h4").text())}})},10)),a.pnp.enableScroll(),a(".nav-container").hasClass("black")&&a(".nav-container").removeClass("black"),$window.trigger("resize");else if(a(".slider-nav").length){var d=a(window).width()<768?window.headHeight-57:window.headHeight;TweenMax.to(window,2,{scrollTo:{y:d,autoKill:!1},ease:Cubic.easeInOut,onStart:function(){a.pnp.enableScroll()}})}a(".old-content").remove(),a("html,body").scrollTop(0),a.pnp.initPage(),a.pnp.initViewportChecker()}},onAfter:function(b,c){a("input[name=current-url]").length&&a("input[name=current-url]").attr("value",window.location.href),$window.trigger("resize")}})},a.pnp.initPage=function(b){a.pnp.initPlaceholderShim(),a.pnp.initSelectric(),a.pnp.initDatePicker(),a.pnp.initFormValidation(),a.pnp.initFixto(),a.pnp.initDropdowns(),a.pnp.initScrollHijack(),a.pnp.initHeaderBanner(),a.pnp.initExpandingCTA(),a.pnp.initColouredText(),a.pnp.initStackedLayers(),a.pnp.initPinned(),a.pnp.initGoogleMaps(),a.pnp.initAccordion(),a.pnp.initCards(),a.pnp.initCustomContactForm7(),a.pnp.initShowcase(),a.pnp.initProcess(),a.pnp.initSmoothstate(),a.pnp.InitMagnify(),a.pnp.initTeam(),a.pnp.responsiveImages(),a.pnp.initFullBleedImages(),a.pnp.initParallaxMedia(),a.pnp.initCustomText(),a.pnp.initPress(),a.pnp.initButtons(),a.pnp.initScrollMagic(),a.pnp.triggeredFromFooter=!1,b&&(a.pnp.initModals(),a.pnp.initBanners(),a.pnp.initSubNav(),a.pnp.initMicrointeractions(),a.pnp.initSliders(),a.pnp.overlayer.init()),setTimeout(function(){$window.trigger("resize")},0)},a.pnp.unbindPage=function(){}}(jQuery),$document.ready(function(){$.pnp.initPage(!0)}),$("#accordion-search-form").length>0){var faqs=[];$("[data-pnp-search-results]").find(".component-accordion .panel").each(function(a){var b=$(this).find(".trigger").text().toLowerCase(),c=$(this).find(".reveal").text().toLowerCase();faqs.push(b+c),$(this).attr("id","faq-"+a)});var $searchBox=$("#accordion-search-box"),$numResults=$("#num-results"),doSearch=function(){$body.addClass("search-active");for(var a=$searchBox.val().toLowerCase(),b=new RegExp("\\b"+a+"\\b","i"),c=0;c<faqs.length;c++)b.test(faqs[c])?$("#faq-"+c+".filtered-out").removeClass("filtered-out"):$("#faq-"+c).addClass("filtered-out");var d=$("[data-pnp-search-results] .panel:not(.filtered-out)").size();$numResults.find(".num-results").html(d),$numResults.show(),1==d?$("#num-results span#plural").hide():$("#num-results span#plural").show(),$(".component-accordion").addClass("filtered-out"),$(".component-accordion .panel:not(.filtered-out)").each(function(){$(this).closest(".component-accordion").removeClass("filtered-out")}),$window.trigger("resize"),pnpHelper.scroll.scrollTo("#num-results")};$searchBox.keyup(function(a){if(0!=$(this).val().length){var b=a.keyCode||a.which;return 13===b&&doSearch(),!1}$(".panel.filtered-out").removeClass("filtered-out"),$body.removeClass("search-active")}),$document.on("click","#clear-search",function(){return $(".filtered-out").removeClass("filtered-out"),$("#num-results").hide(),$(".component.component-text").show(),$("#faq-search-box").val(""),$window.trigger("resize"),!1}),$document.on("submit","#accordion-search-form",function(a){$searchBox.val().length>0?doSearch():($(".panel.filtered-out").removeClass("filtered-out"),$body.removeClass("search-active")),a.preventDefault()})}$(function(){$(".has-background-video").length>0&&(pnpHelper.onResizeFinished(initBannerVideos),$window.trigger("resize"))}),function(a){$document.on("click","[data-pnp-toggle-class]",function(){return a(a(this).data("pnp-target")).toggleClass(a(this).data("pnp-class")),!1}),$document.on("click","[data-pnp-add-class]",function(){return a(a(this).data("pnp-target")).addClass(a(this).data("pnp-class")),!1}),$document.on("click","[data-pnp-remove-class]",function(){return a(a(this).data("pnp-target")).removeClass(a(this).data("pnp-class")),!1}),$document.on("click","[data-pnp-show-toggle]",function(){return a(a(this).data("pnp-hide-target")).hide(),a(a(this).data("pnp-show-target")).show(),a.event.trigger({type:"pnp-show-toggle-complete"}),!1}),$document.on("click","[data-pnp-slide-toggle]",function(){return a(a(this).data("pnp-slide-toggle")).is(":visible")?a(this).addClass("-out").removeClass("-in"):a(this).addClass("-in").removeClass("-out"),a(a(this).data("pnp-slide-toggle")).slideToggle(),!1}),$document.on("click","[data-pnp-slide-up]",function(){return a(a(this).data("pnp-slide-up")).slideUp(),!1}),$document.on("click","[data-pnp-slide-down]",function(){return a(a(this).data("pnp-slide-down")).slideDown(),!1}),$document.on("change","[data-pnp-slide-toggle-change]",function(){a(a(this).data("pnp-slide-toggle-change")).is(":checked")?a(this).addClass("-out").removeClass("-in"):a(this).addClass("-in").removeClass("-out"),a(a(this).data("pnp-slide-toggle-change")).slideToggle()}),$document.on("click","[data-pnp-back]",function(){return window.history.back(),!1}),$document.on("click","[data-pnp-return-false]",function(){return!1}),$document.on("click","[data-pnp-scroll-to],[data-pnp-scroll-past]",function(){if(a(this).data("pnp-scroll-past")){var b=a(this).data("pnp-scroll-past");pnpHelper.scroll.scrollPast(a(this).closest(b))}else a(this).data("pnp-scroll-to")&&pnpHelper.scroll.scrollTo(a(this).data("pnp-scroll-to"));return!1}),$window.bind("resize",function(){a("[data-pnp-equate-height]").each(function(){a(this).find(a(this).data("pnp-equate-height")).css("height","auto");var b=a(this).find(a(this).data("pnp-equate-height")).map(function(){return a(this).outerHeight()}).get(),c=Math.max.apply(null,b);(pnpHelper.bootstrap.isMd()||1==a(this).data("resize-mobile"))&&a(this).find(a(this).data("pnp-equate-height")).css("height",c+"px")})}).trigger("resize")}(jQuery),$.pnp.initAccordion=function(){if($(".component-accordion").length>0){var a=300;$(".component-accordion .trigger").on("click",function(){var b=$(this).closest(".component-accordion"),c=$(this).closest(".panel");if(c.hasClass("active"))c.removeClass("active").find(".reveal").slideUp(a,function(){$window.trigger("resize")});else{var d=b.find(".panel.active");d.removeClass("active").find(".reveal").slideUp(a),c.addClass("active").find(".reveal").slideDown(a,function(){$window.trigger("resize")})}return!1}),$(".component-accordion .trigger.initial-active").trigger("click")}},$.pnp.initBanners=function(){function a(){pnpHelper.bootstrap.isSm()&&$(".component-banner.-video:not(.-playing)").each(function(){var a=$(this),b=$(this).find("video");if(b.length){b.attr("autoplay",!0).removeAttr("preload"),a.addClass("-playing");try{b.get(0).play()}catch(c){console.log("Unable to play video",c)}}else console.warn("Unable to play background hero video, no video found")})}if($(".component-banner").length>0){if($(".component-banner.-video").length>0){var b;$window.resize(function(){clearTimeout(b),b=setTimeout(a,300)}).load(a)}$(".component-banner.-carousel").length>0&&$(".component-banner.-carousel").each(function(){var a=$(this);if(a.find(".carousel-container .slide").length>0){if(a.hasClass("-page-slider")){var b=0,c=a.data("pnp-this-page-url");a.find(".carousel-container .slide").each(function(a){if($(this).data("pnp-page-url")===c)return void(b=a)});var d=a.find(".carousel-container").slick({infinite:!0,mobileFirst:!0,speed:1e3,slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,swipeToSlide:!0,initialSlide:b});a.find(".carousel-prev").hover(function(){a.find(".slick-slider").addClass("peek-left")},function(){a.find(".slick-slider").removeClass("peek-left")}),a.find(".carousel-next").hover(function(){a.find(".slick-slider").addClass("peek-right")},function(){a.find(".slick-slider").removeClass("peek-right")});var e=new pnpHelper.ajaxNavigation;d.on("afterChange",function(a,b,c,d){var f=$(b.$slides[c]).data("pnp-page-url");e.loadPage(f,!0,function(a){})})}else var d=$(this).find(".carousel-container").slick({infinite:!0,mobileFirst:!0,speed:1e3,slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0,swipeToSlide:!0});$document.on("click",".carousel-next",function(a){return d.slick("slickNext"),!1}),$document.on("click",".carousel-prev",function(a){return d.slick("slickPrev"),!1})}})}},$.pnp.initCards=function(){function a(a,b,d){d.current_page=1,a.find(".pagination").on("click",function(){return $(this).hasClass("-prev")&&d.current_page>1?d.current_page--:$(this).hasClass("-next")&&d.current_page++,$.when(c(d)).done(function(c){""==c?a.find(".pagination.-next").hide():a.find(".pagination.-next").show(),console.log(c),b.empty().append(c)}),!1})}function b(a,b,d){var e=!0;d.current_page=1,a.find(".ajax-infinite-scroll-marker").viewportChecker({repeat:!0,callbackFunction:function(a,f){"Remove"!=f&&0!=e&&(d.current_page++,$.when(c(d)).done(function(a){return""==a?void(e=!1):(b.append(a),void $window.trigger("resize"))}))}})}function c(a){var b=$.Deferred(),c={ajax:!0,action:"do_ajax_shortcode"};return c=$.extend(c,a),console.log("test"),console.log(c),$.post(ajax_object.ajax_url,c,function(a){b.resolve(a)}),b}$(".component-cards").each(function(){var c=$(this),d=c.find("[data-ajax]"),e=d.data("ajax");if(c.find(".pagination").length&&a(c,d,e),c.find(".ajax-infinite-scroll-marker").length&&b(c,d,e),c.find(".filter-terms").length){var f=c.find(".isotope-container").isotope({itemSelector:".item",layoutMode:"fitRows"});c.find(".filter-terms .term").on("click",function(){var a=$(this).attr("data-term-id");return a==-1?(f.isotope({filter:"*"}),$(this).closest(".filter-terms").find(".-reset").hide()):(f.isotope({filter:".term-id-"+a}),$(this).closest(".filter-terms").find(".-reset").show()),!1})}})},$.pnp.initCustomText=function(){function a(){var a=window.navigator.userAgent,b=a.indexOf("MSIE ");if(b>0)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);var c=a.indexOf("Trident/");if(c>0){var d=a.indexOf("rv:");return parseInt(a.substring(d+3,a.indexOf(".",d)),10)}var e=a.indexOf("Edge/");return e>0&&parseInt(a.substring(e+5,a.indexOf(".",e)),10)}if($(".component-coloured-text").length){a();$(".component-coloured-text").each(function(){"#ffffff"==$(this).attr("data-bg-colour")&&($(this).find(".mm-button").removeClass("white"),$(this).parent().parent().parent().parent().next().find(".jpg").length&&$(window).width()>747&&$(this).addClass("has-next")),"#1b1b1e"!=$(this).attr("data-bg-colour")&&"#000000"!=$(this).attr("data-bg-colour")||($(this).find(".content p").css("opacity","0.7"),$(window).width()<767&&$(this).parent().parent().parent().parent().next().find(".jpg").length&&$(this).addClass("has-next"),$(this).parent().parent().parent().parent().next().find(".component-full-bleed-image").length&&$(this).addClass("has-next"));var a=$(this).find(".pinned");a.length&&$(window).width()>747&&a.fixTo(a.parent(),{top:70})}),$(".buttons a").each(function(){var a=$(this);"1"===a.attr("data-contact")&&a.click(function(a){a.preventDefault();var b=$(".mm-overlay").attr("data-title"),c=$(".mm-overlay").attr("data-content");$.pnp.overlayer.populate(b,null,c,!0),$.pnp.overlayer.show()})}),$(".mm-button.create, .mm-button.construct").click(function(){var a=$(this).attr("data-title"),b=$(this).attr("data-content");$.pnp.overlayer.populate(a,null,b,!1),$.pnp.overlayer.show()}),$(".no-caption").length&&setTimeout(function(){$(".no-caption").each(function(){var a=$(this),b=a.find(".image img");b.width()<320&&null!==b.width()&&a.removeClass("no-caption")})},20)}},$.pnp.initButtons=function(){$(".buttons").length&&$(".buttons").each(function(){function a(a,b){var c=b.width()+40,d=b.height()+22,e=(a.pageX-b.offset().left-c/2)*(c>d?d/c:1),f=(a.pageY-b.offset().top-d/2)*(d>c?c/d:1),g=Math.round((Math.atan2(f,e)*(180/Math.PI)+180)/90+3)%4;return g}$(this).children("a").length>1&&$(".buttons a").each(function(b){var c=$(this);c.prepend('<div class="overlay"></div>'),c.removeClass("left").removeClass("right").addClass("dynamic"),c.wrap();var d=c.find(".overlay");TweenMax.set(d,{scaleX:0}),c.mouseenter(function(e){var f=a(e,c);switch(c.addClass("over"),f){case 0:b>0?TweenMax.to(d,.5,{scaleX:1,transformOrigin:"0% 50%",ease:Cubic.easeOut}):TweenMax.to(d,.5,{scaleX:1,transformOrigin:"0 50%",ease:Cubic.easeOut});break;case 1:b>0?TweenMax.to(d,.5,{scaleX:1,transformOrigin:"0% 50%",ease:Cubic.easeOut}):TweenMax.to(d,.5,{scaleX:1,transformOrigin:"100% 50%",ease:Cubic.easeOut});break;case 2:b>0?TweenMax.to(d,.5,{scaleX:1,transformOrigin:"0% 50%",ease:Cubic.easeOut}):TweenMax.to(d,.5,{scaleX:1,transformOrigin:"0 50%",ease:Cubic.easeOut});break;case 3:TweenMax.to(d,.5,{scaleX:1,transformOrigin:"0 50%",ease:Cubic.easeOut})}}),c.mouseleave(function(b){var e=a(b,c);switch(c.removeClass("over"),e){case 0:TweenMax.to(d,.5,{scaleX:0,transformOrigin:"100% 50%",ease:Cubic.easeOut});break;case 1:TweenMax.to(d,.5,{scaleX:0,transformOrigin:"100% 50%",ease:Cubic.easeOut});break;case 2:TweenMax.to(d,.5,{scaleX:0,transformOrigin:"0 50%",ease:Cubic.easeOut});break;case 3:TweenMax.to(d,.5,{scaleX:0,transformOrigin:"0 50%",ease:Cubic.easeOut})}})})})},$.pnp.initExpandingCTA=function(){function a(){var a=window.navigator.userAgent,b=a.indexOf("MSIE ");if(b>0)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);var c=a.indexOf("Trident/");if(c>0){var d=a.indexOf("rv:");return parseInt(a.substring(d+3,a.indexOf(".",d)),10)}var e=a.indexOf("Edge/");return e>0&&parseInt(a.substring(e+5,a.indexOf(".",e)),10)}var b=$(".component-expanding-cta"),c=a();b.length&&(!c&&$(".slider-nav").length||b.removeClass("smoothstate"),b.find("a").click(function(a){$.pnp.triggeredFromFooter=!0,$.pnp.currentTarget=$(this).attr("href")}))},$.pnp.initCustomContactForm7=function(){$(".wpcf7").on("wpcf7:invalid",function(a){$(".equalise").addClass("-transition"),$window.trigger("resize")}),$("input[name=current-url]").length&&$("input[name=current-url]").attr("value",window.location.href),$("body").hasClass("contact")&&$(window).width()>767&&$(".component-form").find("h2").appendTo($(".component-form").find(".content")),$("body").hasClass("contact")&&$(window).width()<768&&($(".component-form").find("h2").appendTo($(".component-form").find(".text-container")),$(".component-form").find(".content").appendTo($(".component-form").find(".form-container").parent()).css({display:"inline-block","margin-top":"6%"}))},$.pnp.initFullBleedImages=function(){$(".component-full-bleed-image").length&&$(".component-full-bleed-image").each(function(){$(this).parent().parent().parent().parent().next().find(".component-full-bleed-image").length&&($(this).parent().parent().parent().parent().css("padding",0),$(this).addClass("next")),$(this).parent().parent().parent().parent().prev().find(".brand-color").length&&$(this).addClass("after-brand")})},$.pnp.initGoogleMaps=function(){function a(a,b,c,e,f){c[a].addListener("click",function(){d(a,b,c,e),f.prop("selectedIndex",a).selectric("refresh")})}function b(a,b,c){var d=new google.maps.Circle({strokeColor:"#FF0000",strokeOpacity:.8,strokeWeight:2,fillColor:"#FF0000",fillOpacity:.35,map:a,center:c,radius:b});return d}function c(a,b,c){function d(){null!==e.getAnimation()?e.setAnimation(null):e.setAnimation(google.maps.Animation.BOUNCE)}var e=new google.maps.Marker({position:b,map:a,icon:{url:c,scaledSize:new google.maps.Size(56.5,71)},animation:google.maps.Animation.DROP});return e.addListener("click",d),e}function d(a,b,c,d){b.panTo(c[a].position),d.find(".map-panel:visible").slideUp(),d.find(".map-panel.map-"+a).slideDown()}var e={scrollwheel:!1,zoom:14};$(".component-google-map").length&&$(".component-google-map").each(function(f){var g=[];e.img=$(this).data("img"),e.markers=$(this).data("markers"),e.radiuses=$(this).data("radiuses"),e.lat="51.0199613",e.lng="-0.4694492",e.disableDefaultUI=!0,e.styles=[{elementType:"geometry",stylers:[{color:"#f5f5f5"}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{elementType:"labels.text.stroke",stylers:[{color:"#f5f5f5"}]},{featureType:"administrative.land_parcel",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"road",elementType:"geometry",stylers:[{color:"#ffffff"}]},{featureType:"road.arterial",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#dadada"}]},{featureType:"road.highway",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{color:"#e5e5e5"}]},{featureType:"transit.station",elementType:"geometry",stylers:[{color:"#eeeeee"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#c9c9c9"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]}];var h=new google.maps.Map($(this)[0],e),i=new google.maps.LatLng(e.lat,e.lng);h.setCenter(i);var j=new google.maps.LatLngBounds;for(var k in e.markers){var l=e.markers[k],i=new google.maps.LatLng(l.lat,l.lng),m=e.img,n=c(h,i,m);g.push(n),j.extend(i)}for(var k in e.radiuses){var o=e.radiuses[k],i=new google.maps.LatLng(o.lat,o.lng);b(h,parseInt(o.size),i),j.extend(i)}if(e.markers.length+e.radiuses.length===1){if(1===e.markers.length){var i=new google.maps.LatLng(e.markers[0].lat,e.markers[0].lng);h.setZoom(13)}else{var i=new google.maps.LatLng(e.radiuses[0].lat,e.radiuses[0].lng);h.setZoom(10)}h.setCenter(i)}else if(h.fitBounds(j),$(this).hasClass("-search")||$(this).hasClass("-google_map_key"))var p=google.maps.event.addListener(h,"idle",function(){h.setZoom(h.getZoom()-1),google.maps.event.removeListener(p)});if($(this).hasClass("-google_map_key")){var q=$(this).closest(".component-google-map-container");q.find(".map-key-toggle").addClass("map-key-toggle-"+f),$(".map-key-toggle-"+f).on("selectric-change, change",function(a,b,c){d($(this).val(),h,g,q)});for(var r=$(this).parent(".component-google-map-container").find(".map-key-toggle"),s=0;s<g.length;s++)a(s,h,g,q,r)}if($(this).hasClass("-search")){var t;$('[data-pnp-slider-config="property-search"]').slick({infinite:!0,mobileFirst:!0,slidesToShow:1,slidesToScroll:1,speed:600,dots:!1,swipeToSlide:!0,prevArrow:"#prop-prev",nextArrow:"#prop-next"}).on("beforeChange",function(a,b,c,d){$("#current_properties").html(d+1),t&&t.setIcon(e.img);var f=g[d];f.setIcon("/wp-content/themes/pegasus/dist/img/marker.png"),h.panTo(f.position),t=f})}})},function(a){a(".component.component-header-banner").find("button").click(function(){var b=a(this).closest(".component.layout"),c=a(b).next(".component.layout");a("html, body").animate({scrollTop:a(c).offset().top},2e3)})}(jQuery),$(function(){$('[data-toggle="tooltip"]').tooltip({trigger:"click",placement:"auto"}),pnpHelper.onResizeFinished(function(){$('[data-toggle="tooltip"]').tooltip("show")}),$(".point-btn").on("click",function(){var a=$(this).closest(".component-floorplan"),b=a.find(".point-container");return a.find(".img-container, .button").toggleClass("-in"),b.is(":visible")?b.slideUp(400,function(){$window.trigger("resize").trigger("scroll")}):b.slideDown(400,function(){a.find(".hotspot-tooltip[aria-describedby]").trigger("click"),$window.trigger("resize").trigger("scroll")}),!1})}),$(function(){var a=5e3,b=$(".preload .component-loading-screen"),c=$(".captions-full li:first-child .caption h5").length?$(".captions-full li:first-child .caption h5"):$(".captions-full li:first-child .caption p");if(b.length)if(console.log("found loading screen"),b.hasClass("-standard"))$(".preload .component-loading-screen").delay(a).fadeOut();else if(b.hasClass("-intro"))b.find(".page-intro").addClass("-in"),setTimeout(function(){b.find(".bullet").addClass("-in")},1200),setTimeout(function(){b.find(".inner").addClass("-out"),b.find(".background").addClass("-out")},4e3),setTimeout(function(){b.fadeOut()},a);else if(b.hasClass("-text")){$(".intro-text").css("display","block");var d=$(".st0");TweenMax.set(c,{autoAlpha:0}),TweenMax.set(".minale-logo, .captions-full li:first-child .caption .subtitle, .captions-full li:first-child .caption h4",{autoAlpha:0}),TweenMax.fromTo(".minale-logo",1,{autoAlpha:0},{autoAlpha:1,delay:.1}),TweenMax.staggerFrom(d,1.5,{autoAlpha:0,ease:Cubic.easeOut},.05),TweenMax.staggerTo(d,.8,{autoAlpha:0,ease:Cubic.easeInOut,delay:1.2},.05),TweenMax.allTo([".background>.top",".background>.bottom"],.8,{height:0,ease:Cubic.easeOut,delay:2.2,onStart:function(){TweenMax.set(".minale-logo, .captions-full li:first-child .caption .subtitle, .captions-full li:first-child .caption h4",{autoAlpha:0}),$(".captions-full").css("display","block"),TweenMax.set(c,{autoAlpha:0})},onComplete:function(){if(b.remove(),$(".captions-full").length){TweenMax.set($(".captions-full p"),{autoAlpha:1}),$(".captions-full p").css("opacity",1),TweenMax.fromTo(".captions-full li:first-child .caption .subtitle",.5,{autoAlpha:0,ease:Cubic.easeOut},{autoAlpha:1}),TweenMax.fromTo(".captions-full li:first-child .caption h4",.5,{autoAlpha:0,delay:.2,ease:Cubic.easeOut},{autoAlpha:1});var a=new SplitText(c,{type:"chars,words,lines"});TweenMax.set(c,{autoAlpha:1}),TweenMax.staggerFrom(a.words,2,{autoAlpha:0,ease:Cubic.easeOut},.02)}}})}var e=!1;$("body").delegate("a","click",function(){e=!0}),window.onbeforeunload=function(){}}),$.pnp.InitMagnify=function(){function a(){$(".select-view li").removeClass("active")}function b(){$(".component-magnifying-image").each(function(){var a=$(this).find(".views"),b=($(this).find(".view"),$(this).find(".select-view>ul")),c=b.offset().left+b.width();$(window).width()>1e3&&TweenMax.set(a,{x:c,width:$(window).width()-c-180})})}if(".component-magnifying-image".length){$(".zoom").magnify(),$(".select-view li:first-child").addClass("active"),$(".component-magnifying-image").each(function(){var b=$(this),c=!!$(this).find(".fade-mode").length,d=($(this).find(".views"),$(this).find(".view"),$(this).find(".pinned"));if(d.length&&$(window).width()>747){var e=$(window).width()<747?80:110;d.fixTo(d.parent(),{top:e})}$(".select-view li").each(function(){$(this).click(function(){var d=$(this).attr("data-key");if(console.log("clicked "+d),a(),$(this).addClass("active"),c){var e=$(".view[data-key='"+d+"']").find(".last");e.css("opacity",0)}var f=2;TweenMax.to(b.find(".views"),2,{height:$(".view[data-key='"+d+"']").height(),ease:Cubic.easeInOut}),TweenMax.to(".view[data-key='"+d+"']",f,{autoAlpha:1,onComplete:function(){c&&TweenMax.to(e,f,{autoAlpha:1,delay:1})}}),TweenMax.to(".view:not([data-key='"+d+"'])",f,{autoAlpha:0})})})}),$(window).resize(function(){b()}),b();var c=$(".view[data-key='0']").find(".last");$(".component-magnifying-image").viewportChecker({callbackFunction:function(a,d){console.log("magnify in sight!"),TweenMax.fromTo(c,.5,{autoAlpha:0,delay:1},{autoAlpha:1}),b()}})}},function(a){if(!pnpHelper.dependencyCheck.requireDependencies("Microinteration",[pnpHelper.dependencyCheck.jqueryCookie])){a.cookie.json=!0;var b=999,c="micro-interactions",d=a.cookie(c);d||(d={total:0,counts:{},closes:[]}),a.fn.microInteraction=function(e){var f=a(this),g=this,h=f.data("pnp-mi-id"),i="1"==f.data("pnp-mi-debug-mode"),j={removeAfter:0,showRepeatedly:!0,classOnShow:"animated fadeInUp",classOnHide:"animated fadeOutDown"};return e&&(j=a.extend({},j,e)),i&&(j.showRepeatedly=!0),f.find("[data-pnp-mi-close]").click(function(){return g.hideInteraction(),a("html").removeClass("mi-open"),!1}),this.hideInteraction=function(){var a=j.classOnShow.split(" ");if(a.length>1)for(var b=0;b<a.length;b++)f.removeClass(a[b]);else f.removeClass(j.classOnShow);f.addClass(j.classOnHide),d.closes.push(h),g.updateCookie(),setTimeout(function(){f.hide()},1e3)},this.showInteraction=function(){i&&(console.info("Number of times you have seen this microinteraction:",g.getShowCount()),console.info("Total number of microinteractions seen:",d.total)),(d.total<b&&a.inArray(h,d.closes)==-1&&(j.showRepeatedly||0==g.getShowCount())||i)&&(a("html").addClass("mi-open"),f.show(),f.addClass(j.classOnShow),g.incrementShowCount(),g.updateCookie(),j.removeAfter>0&&setTimeout(function(){g.hideInteraction(),a("html").removeClass("mi-open")},j.removeAfter))},this.getShowCount=function(){return d.counts[h]||(d.counts[h]=0),d.counts[h]},this.incrementShowCount=function(){g.getShowCount(),d.counts[h]++,d.total++},this.updateCookie=function(){a.cookie(c,d,{path:"/"})},this}}}(jQuery),$.pnp.initMicrointeractions=function(){$(".component-microinteraction").length&&$("[data-pnp-mi-delay]").each(function(){var a=$(this),b={};a.data("pnp-mi-config")&&(b={removeAfter:0,showRepeatedly:!0,classOnShow:"animated fadeInUp",classOnHide:"animated fadeOutDown"}),_delay=5e3,parseInt(a.data("pnp-mi-delay"))&&(_delay=a.data("pnp-mi-delay"));var c=a.microInteraction(b);setTimeout(function(){c.showInteraction()},_delay)})},$.pnp.initModals=function(){if(!pnpHelper.dependencyCheck.requireDependencies("Modals",[pnpHelper.dependencyCheck.bootstrapModal])){$("[data-pnp-open-in-modal]").not(".modal").length&&(setTimeout(function(){var a=$("#modal-skeleton");$("[data-pnp-open-in-modal]").not(".modal").each(function(b){var c=$(this),d="modal-container";c.data("pnp-open-in-modal").length>0&&(d+=" "+c.data("pnp-open-in-modal"));var e=new Url(c.attr("href"));e.query.modal="yes",console.log("Preloading modal:"+e),$.get(e,function(e){var f=e;f=f.replace("pnp-modal-link",""),$body.append("<div id='modal-"+b+"' class='"+d+"'>"+a.html()+"</div>"),$("#modal-"+b+" .modal-body").html(f),c.attr("data-pnp-modal-id","#modal-"+b),d.indexOf("-basket-modal")>-1&&$("#modal-"+b+" > .modal").on("show.bs.modal",function(a){})}).fail(function(a){console.warn("Unable to preload modal "+e,a)})})},1e3),$document.on("click","[data-pnp-modal-id]",function(){return pnpHelper.modal.open($(this).data("pnp-modal-id")+" > .modal"),!1}),$document.on("click",".modal-backdrop.fade.in",function(){$document.find(".pnp-modal.in").modal("hide")}))}},$(function(){$(".nav-container .has-children").hoverIntent(function(){$(this).find(".dropdown-menu").show()},function(){$(this).find(".dropdown-menu").hide()})}),$(function(){function a(){$(".navbar-toggle-multi-level").removeClass("active"),$html.removeClass("mob-nav-in"),d.fadeOut()}function b(){$(".navbar-toggle-multi-level").addClass("active"),$html.addClass("mob-nav-in"),d.fadeIn()}function c(){$html.hasClass("mob-nav-in")?a():b()}if($(".multi-level-mob-menu").length>0){var d=$("#side-menu-veil");$document.on("click",".navbar-toggle-multi-level",function(){return c(),!1}),$document.on("click","#side-menu-veil",function(){return c(),!1});var e;$document.on("click",".pnp-nav-has-child-menu",function(){return $(this).parent().find("aside").first().addClass("in"),navigator.userAgent.indexOf("Safari")>-1&&(e=$("#menu-main-menu").scrollTop(),$("#menu-main-menu").scrollTop(0),$("#menu-main-menu").css("overflow-y","hidden")),!1}),$document.on("click",".pnp-nav-back",function(){return $(this).closest("aside").removeClass("in"),null!=e&&($("#menu-main-menu").css("overflow-y","auto"),$("#menu-main-menu").scrollTop(e)),!1})}}),$(function(){$(".mobile-standard").length>0&&$document.on("click",".navbar-toggle-overlay",function(){var a=$(this),b=$(".overlay-mob-menu");b.is(":visible")?(a.removeClass("active"),b.fadeOut()):(a.addClass("active"),b.fadeIn())})}),$(function(){$(".mobile-standard").length>0&&$document.on("click",".navbar-toggle-standard",function(){var a=$(this),b=$("#mob-nav-container");b.is(":visible")?(a.removeClass("active"),b.slideUp()):(a.addClass("active"),b.slideDown())})}),$.pnp.overlayer={init:function(){$(".mm-overlay .shade, .mm-close").click(function(){console.log("closing"),$.pnp.overlayer.hide()})},show:function(){$(".mm-overlay, .mm-close").css("display","block"),$("body").css("overflow-y","hidden"),TweenMax.to(".view-toggle",.3,{autoAlpha:0}),$(".nav-container").hasClass("black")||$(".nav-container").addClass("black"),$(window).width()<747&&($(".nav-container.black .image .header-logo").css("fill","#00222b"),$(".nav-container").hasClass("full-background")&&$(".nav-container").removeClass("full-background")),$(".navbar-toggle").addClass("active"),$(".navbar-toggle").addClass("black"),TweenMax.fromTo(".mm-overlay .shade",1.5,{autoAlpha:0},{autoAlpha:1,ease:Cubic.easeOut}),TweenMax.fromTo(".mm-overlay .inner",1.5,{x:"100%"},{x:"0%",force3D:"auto",ease:Cubic.easeOut,delay:.2,onStart:function(){$(".mm-overlay").find(".wrap").scrollTop(0),TweenMax.to(".mm-close",.2,{autoAlpha:1,delay:.5})}})},hide:function(){$("body").css("overflow-y","auto"),$(".navbar-toggle").removeClass("active"),$(".navbar-toggle").removeClass("black"),TweenMax.to(".view-toggle",.3,{autoAlpha:1}),TweenMax.to(".mm-overlay .shade",.5,{autoAlpha:0,ease:Cubic.easeOut}),TweenMax.to(".mm-close",.1,{autoAlpha:0}),$(window).width()<747&&($(".nav-container.black .image .header-logo").css("fill","#ffffff"),$(".nav-container").hasClass("full-background")||$(".nav-container").addClass("full-background")),TweenMax.to(".mm-overlay .inner",1,{x:"100%",ease:Cubic.easeOut,onComplete:function(){$(".mm-overlay, .mm-close").css("display","none"),console.log("showing team overlay y: "+$(".mm-overlay").find(".wrap").scrollTop())}})},populate:function(a,b,c,d){$(".mm-overlay>.inner .title").text(a),null!==b?$(".mm-overlay>.inner .subtitle").text(b).css("display","block"):$(".mm-overlay>.inner .subtitle").css("display","none"),$(".mm-overlay>.inner .content").html(c),d?$(".mm-overlay>.inner>.wrap").find(".form-wrap").css("display","block"):$(".mm-overlay>.inner>.wrap").find(".form-wrap").css("display","none")}},$.pnp.initParallaxMedia=function(){var a=$(".component-parallax-image");a.length&&a.each(function(a){var b=$(this).parent().parent().parent().parent();if(b.hasClass("padded")||(b.addClass("padded"),$(this).find(".col-xs-12").css({"padding-top":0,"padding-bottom":0})),$(this).find(".video").length){var c=$(this).find(".video"),d=c.attr("data-video"),e=c.attr("data-poster");""!==d&&void 0!==d&&c.vide({mp4:d,poster:e},{volume:0,playbackRate:1,muted:!0,loop:!0,autoplay:!0,position:"0% 50%",posterType:"jpg",resizing:!0,bgColor:"#000000",className:""})}})},$.pnp.initPinned=function(){var a=$(".component-pinned-text.pinned");a.length&&a.each(function(){var b=$(this);b.fixTo(a.parent(),{top:90}),b.parent().hasClass("equalise")||(b.parent().parent().attr("data-pnp-equate-height",".equalise"),b.parent().parent().find(".col-sm-6").addClass("equalise"),$(window).trigger("resize"))})},$.pnp.initPress=function(){$(".component-press").length&&(console.log("found press component!"),$(".component-press .item").each(function(){var a=$(this);void 0!==a.attr("data-overlay")&&void 0!==a.attr("data-content")&&(a.addClass("clickable"),a.click(function(b){b.preventDefault();var c=a.attr("data-title"),d=a.attr("data-content");$.pnp.overlayer.populate(c,null,d,!1),$(".mm-overlay .content").find("img").attr("sizes","(max-width: 1000px) 1000vw 1000px"),$.pnp.overlayer.show()}))}))},$.pnp.initProcess=function(){$(".component-process").length&&$(".component-process").each(function(){var a=$(this);a.parent().parent().parent().parent().next().find(".component-process").length&&a.addClass("next"),a.parent().parent().parent().parent().next().find(".jpg").length&&a.addClass("has-next")})},$.pnp.initShowcase=function(){$(".component-showcase").length&&($.fn.showcase=function(){pnpHelper.dependencyCheck.requireDependencies("Showcase",[pnpHelper.dependencyCheck.fixTo,pnpHelper.dependencyCheck.viewportChecker])||$(this).each(function(a){function b(a){e.find(".active").removeClass("active"),e.find('[data-pnp-showcase="'+a+'"]').closest("li").addClass("active"),h.hasClass("-showcase_fade_images")&&(h.find(".showcase-wrapper-0 .showcase-image.-in").removeClass("-in"),
h.find(".showcase-wrapper-0 .showcase-image-"+a).addClass("-in"))}function c(a){f=!0;var b=d.find('.showcase-item[data-pnp-showcase="'+a+'"]');pnpHelper.scroll.scrollTo(b,function(){f=!1},pnpHelper.getNavHeight())}var d=$(this),e=d.find(".scroll-indicators"),f=!1,g=-1,h=$(this);if($(this).find(".sticky-bar").length>0){var i=$(this).find(".sticky-bar");i.fixTo("body",{useNativeSticky:!0,top:pnpHelper.getNavHeight()}),pnpHelper.onResizeFinished(function(){pnpHelper.bootstrap.isSm()?(i.fixTo("start"),i.fixTo("setOptions",{top:pnpHelper.getNavHeight()})):i.fixTo("stop")})}if($(this).hasClass("-showcase_fixed_images")||$(this).hasClass("-showcase_fade_images")){var j=$(this).find(".showcase-wrapper-0").fixTo(".component-showcase",{useNativeSticky:!1,top:pnpHelper.getNavHeight()});pnpHelper.onResizeFinished(function(){pnpHelper.bootstrap.isSm()?(j.fixTo("start"),j.fixTo("setOptions",{top:pnpHelper.getNavHeight()})):j.fixTo("stop")})}$(this).find(".scroll-indicators").length>0&&$(this).find(".scroll-indicators").fixTo(".component-showcase",{useNativeSticky:!1}),$(this).find(".scroll-indicators a").click(function(){var a=$(this).data("pnp-showcase");return b(a),c(a),!1}),$(this).find(".showcase-item").viewportChecker({repeat:!0,offset:"50%",callbackFunction:function(a,c){g==a.data("pnp-showcase")||f||(b(a.data("pnp-showcase")),g=a.data("pnp-showcase"))}})})},$(".component-showcase").showcase())},$(function(){function a(){var a=window.navigator.userAgent,b=a.indexOf("MSIE ");if(b>0)return parseInt(a.substring(b+5,a.indexOf(".",b)),10);var c=a.indexOf("Trident/");if(c>0){var d=a.indexOf("rv:");return parseInt(a.substring(d+3,a.indexOf(".",d)),10)}var e=a.indexOf("Edge/");return e>0&&parseInt(a.substring(e+5,a.indexOf(".",e)),10)}function b(){TweenMax.staggerFromTo(".menu-wrapper>ul.text-menu>li, .first-level li, .second-level li",1,{x:100,autoAlpha:0},{x:0,autoAlpha:1,ease:Cubic.easeOut},.1)}function c(){TweenMax.staggerTo(".menu-wrapper>ul.text-menu>li, .first-level li, .second-level li",.5,{x:50,autoAlpha:0,ease:Cubic.easeInOut,onComplete:m},.05)}function d(a){var b=Math.max(0,Math.min(1,a)),c=$(".progress").width(),d=$(".progress-bar").width(),e=c-d;TweenMax.set(".progress-bar",{x:b*e+"px"})}function e(a){a=a||0,C.slides.forEach(function(a,b){var c=B[b],d=(a.target+C.x)*-1/3;u.hasClass("ready")&&D?TweenMax.set(c,{x:d}):TweenMax.to(c,.5,{x:0,ease:Cubic.easeOut})})}function f(a,b,c){return Math.max(0,Math.min(1,a-c/(b-c)))}function g(){window.countDown=TweenMax.fromTo(".countdown>.bar",8,{width:0},{width:"100%",delay:8,ease:Cubic.easeInOut,onComplete:function(){t.flickity("next");var a=parseInt(C.selectedIndex+1),b=parseInt(C.slides.length);a<b?g():TweenMax.set(".countdown>.bar",{width:0})}})}function h(a){var b=a.replace(/\/$/,""),c=b.replace(/^http:/,"https:");return c}function i(a,b){var c=a||"";var curP=window.location.pathname.replace(/\/index\.html$/,"").replace(/\/$/,"");var tarP=c.replace(window.location.origin,"").replace(/\/index\.html$/,"").replace(/\/$/,"");var sameP=(!c||c==="#"||c==="/"||c===v||tarP===curP||window.location.href===c);if(!sameP&&c.indexOf("#")!==0){l(),window.mobilecheck()||$.pnp.disableScroll(),$("html,body").scrollTop(0),s.load(a)}else{var d=$(window).width()<767?(window.headHeight?window.headHeight-57:$(window).height()-57):(window.headHeight||$(window).height());if($.pnp&&$.pnp.enableScroll)$.pnp.enableScroll();$("html,body").stop().animate({scrollTop:d},700);if(typeof TweenMax!=="undefined")TweenMax.to(window,.7,{scrollTo:{y:d,autoKill:!1,rotation:.01},ease:Cubic.easeInOut,onComplete:function(){$.pnp&&$.pnp.enableScroll&&$.pnp.enableScroll()}})}}function j(){C.options.draggable=!1,C.options.selectedAttraction=x,C.options.friction=y,C.updateDraggable(),$(".next, .back").css({width:"20%"}),A.set({enable:!0}),TweenMax.to(window,.5,{scrollTo:{y:0,autoKill:!1},ease:Power3.easeOut}),TweenMax.to(u.find(".append"),.5,{autoAlpha:0}),setTimeout(function(){u.removeClass("zoom"),$(".nav-container").hasClass("black")&&$(".nav-container").removeClass("black")},300),TweenMax.to(".slider-nav>.slider-wrapper",2,{scale:1,ease:Cubic.easeInOut,onStart:function(){$(".slider-nav>.slider-wrapper").removeClass("zoomed-out");var a=$(".slick-current").children("a");a.attr("title"),a.attr("href");setTimeout(function(){$(".captions-full ul li").find("button").removeClass("in").css("visibility","hidden")},500)},onComplete:function(){u.hasClass("ready")||u.addClass("ready"),TweenMax.set(".captions-full .is-selected .subtitle, .captions-full .is-selected h4, .captions-full .is-selected p",{autoAlpha:0}),TweenMax.set(".captions-full .is-selected .seo-title",{autoAlpha:0}),TweenMax.to(".slider-nav>.slider-wrapper .caption, .slider-nav .captions-full",1,{autoAlpha:1,onComplete:function(){$(window).width()<767?TweenMax.to($(".captions-full .is-selected").find(".seo-title"),1,{autoAlpha:.5,delay:.35,ease:Cubic.easeOut,onComplete:function(){$(".captions-full ul li.is-selected").find("button").not(".in").addClass("in").css("visibility","visible")}}):TweenMax.to($(".captions-full .is-selected").find("p"),1,{autoAlpha:1,delay:.5,ease:Cubic.easeOut,onComplete:function(){$(".captions-full ul li.is-selected").find("button").not(".in").addClass("in").css("visibility","visible")}}),TweenMax.to($(".captions-full .is-selected").find("h4"),1,{autoAlpha:1,delay:.2,ease:Cubic.easeOut,onComplete:function(){}}),TweenMax.to($(".captions-full .is-selected").find(".subtitle"),1,{autoAlpha:1,delay:.1,ease:Cubic.easeOut,onComplete:function(){TweenMax.to($(".captions-full").find("p"),.5,{autoAlpha:1}),$(".captions-full ul li.is-selected").find("button").not(".in").addClass("in").css("visibility","visible")}}),TweenMax.to($(".captions-full .is-selected").find(".subtitle").find(".seo-title"),1,{autoAlpha:.5,delay:.15,ease:Cubic.easeOut})}})}}),TweenMax.to(".slider-nav .arrow",.5,{autoAlpha:1,delay:.5}),r||TweenMax.to(".slides li .background",.3,{x:0}),TweenMax.to(".progress-wrap, .section-wrap",.5,{autoAlpha:0}),TweenMax.to(".countdown",.5,{delay:.5,autoAlpha:1})}function k(a){a=a||0;var b=$(window).width()<768?38:45,c=$(window).width()<768?.5:.4;C.options.draggable=!0,C.options.selectedAttraction=.01,C.options.friction=.18,C.updateDraggable(),$.pnp.disableScroll(),$(".nav-container").hasClass("black")&&$(".nav-container").removeClass("black"),a?($(".slides li .background").each(function(){$(this).addClass("no-transition")}),setTimeout(function(){$(".slides li .background").each(function(){$(this).removeClass("no-transition")})},10),null!==window.countDown&&void 0!==window.countDown&&window.countDown.pause(0),$(".next, .back").css({width:"5%"}),A.set({enable:!1}),u.addClass("zoom"),TweenMax.set(".slides",{top:0}),r||TweenMax.set(".slides li .background",{x:0}),TweenMax.set(".progress-wrap",{autoAlpha:1}),TweenMax.set(".countdown, .slider-nav .arrow, .slider-nav>.slider-wrapper .caption, .slider-nav .captions-full",{autoAlpha:0}),TweenMax.set(u,{transformOrigin:"50vw "+b+"vh",scale:c}),u.removeClass("ready"),u.addClass("zoomed-out"),TweenMax.set(u.find(".append"),{autoAlpha:1})):(TweenMax.to(window,0,{scrollTo:{y:0,autoKill:!1},autoKill:!1,ease:Power3.easeOut}),u.hasClass("ready")&&(null!==window.countDown&&void 0!==window.countDown&&window.countDown.pause(0),$(".next, .back").css({width:"5%"}),A.set({enable:!1}),"true"===localStorage.getItem("auto_zoom")?TweenMax.set(".captions-full",{autoAlpha:0}):TweenMax.to(".captions-full",.2,{autoAlpha:0}),u.addClass("zoom"),window.zoomEffect(!0),TweenMax.to(".progress-wrap, .section-wrap",.5,{delay:2,autoAlpha:1}),TweenMax.to(".countdown",.5,{autoAlpha:0}),TweenMax.to(".slider-nav>.slider-wrapper .caption, .slider-nav .captions-full",.4,{autoAlpha:0}),TweenMax.to(".slider-nav .arrow",.4,{autoAlpha:0}),r||window.mobilecheck()||window.ie||e(!0),TweenMax.to(u,2,{transformOrigin:"50vw "+b+"vh",scale:c,ease:Cubic.easeInOut,onComplete:function(){TweenMax.to(u.find(".append"),.5,{autoAlpha:1,onStart:function(){u.removeClass("ready"),u.addClass("zoomed-out"),TweenMax.to(".captions-full",.2,{autoAlpha:0}),r||window.mobilecheck()||window.ie||e()}})}}),TweenMax.to(".slides",2,{top:0,ease:Cubic.easeInOut}),r||TweenMax.to(".slides li .background",.3,{x:0})))}function l(){$(".project .case").html($(".captions-full li.is-selected .inner .caption h4").text())}function m(){TweenMax.set($(".main"),{x:0}),TweenMax.set($(".submenu.first, .submenu.second"),{x:0,autoAlpha:0}),$("#side-menu-container, #desktop-nav ").removeClass("extended"),$("#side-menu-container, #desktop-nav ").removeClass("expanded"),$(".first-level, .second-level").css("display","none"),TweenMax.set($(".side-menu-container .main, .submenu"),{x:"100%"}),TweenMax.set($(".submenu"),{autoAlpha:0}),$(".submenu.first").removeClass("active"),$(".main a").removeClass("active"),n()}function n(){TweenMax.to($('ul.text-menu li a:not(".hovering, .active")'),.5,{alpha:.5,ease:Cubic.easeOut})}function o(a,b){b=b||0;var c;if(2===b){c=$(window).width()<768?"-11%":"20%";var d="hidden"===$(".submenu.second").css("visibility")?0:.5;TweenMax.to(".submenu.second",d,{autoAlpha:0,onComplete:function(){$("#side-menu-container, #desktop-nav").addClass("extended"),$("a [data-trigger='"+a+"']").addClass("active"),$(".submenu.second .text-menu, .submenu.second .line").css({display:"none"}),$(".submenu.second").find("."+a).css({display:"table-cell"}),$(".submenu.second").find("."+a).parent().find(".line").css({display:"table-cell"}),TweenMax.set($(".submenu.second li"),{x:50,autoAlpha:0}),TweenMax.set($(".submenu.second").find("."+a).parent().find(".line"),{scaleY:0}),TweenMax.to($(".sub-link[data-trigger='"+a+"']"),.5,{autoAlpha:1}),TweenMax.to($(".main"),1,{x:c,ease:Cubic.easeInOut}),TweenMax.to($(".submenu.first, .submenu.second"),1,{x:c,autoAlpha:1,ease:Cubic.easeInOut,onComplete:function(){n()}}),TweenMax.staggerTo($(".submenu.second").find("."+a).find("li"),1,{x:0,autoAlpha:1,ease:Cubic.easeOut,delay:.5},.1),TweenMax.to($(".submenu.second").find("."+a).parent().find(".line"),2,{scaleY:1,transformOrigin:"top left",force3D:"auto",delay:1,ease:Cubic.easeOut}),$(".submenu.second").attr("data-current",a)}})}else{c="50%";var d="hidden"===$(".submenu.first").css("visibility")?0:.5;TweenMax.to(".submenu.second",.5,{autoAlpha:0,ease:Cubic.easeOut}),TweenMax.to(".submenu.first",d,{autoAlpha:0,onComplete:function(){$("#side-menu-container, #desktop-nav").addClass("expanded"),$("a [data-trigger='"+a+"']").addClass("active"),$(".submenu.first .text-menu, .submenu.first .line").css({display:"none"}),$(".submenu.first").find("."+a).css({display:"table-cell"}),$(".submenu.first").find("."+a).parent().find(".line").css({display:"table-cell"}),TweenMax.to(".submenu.second",1,{x:c,autoAlpha:0,ease:Cubic.easeInOut}),TweenMax.set($(".submenu.first li"),{x:50,autoAlpha:0}),TweenMax.set($(".submenu.first").find("."+a).parent().find(".line"),{scaleY:0}),TweenMax.to($(".sub-link[data-trigger='"+a+"']"),.5,{autoAlpha:1}),TweenMax.to($(".main"),1,{x:c,ease:Cubic.easeInOut}),TweenMax.to($(".submenu.first"),1,{x:c,autoAlpha:1,ease:Cubic.easeInOut,onComplete:function(){n()}}),TweenMax.staggerTo($(".submenu.first").find("."+a).find("li"),1,{x:0,autoAlpha:1,ease:Cubic.easeOut,delay:.5},.1),TweenMax.to($(".submenu.first").find("."+a).parent().find(".line"),2,{scaleY:1,transformOrigin:"top left",force3D:"auto",delay:1,ease:Cubic.easeOut}),$(".submenu.first").attr("data-current",a)}})}}function p(a,b){b=b||0;var c;2===b?(c="100%",a=void 0!==a?a:$(".submenu.second").attr("data-current"),$("#side-menu-container, #desktop-nav").removeClass("extended"),$(".submenu.second").removeClass("active"),$(".main a").removeClass("active"),TweenMax.staggerTo($(".submenu.second").find("."+a).find("li"),1,{x:50,autoAlpha:0,ease:Cubic.easeOut},-.1),TweenMax.to($(".main"),1,{x:"100%",ease:Cubic.easeInOut}),TweenMax.to($(".submenu.second"),1,{x:"100%",autoAlpha:0,ease:Cubic.easeInOut,onComplete:function(){$(".submenu.second").attr("data-current")!==a&&void 0!==a&&(o(a,2),$(".main a[data-trigger='"+a+"']").addClass("active"),n())}})):(c="50%",a=void 0!==a?a:$(".submenu.first").attr("data-current"),$("#side-menu-container, #desktop-nav").removeClass("expanded"),$(".submenu.first").removeClass("active"),$(".main a").removeClass("active"),TweenMax.staggerTo($(".submenu.first").find("."+a).find("li"),1,{x:50,autoAlpha:0,ease:Cubic.easeOut},-.1),TweenMax.to($(".main"),1,{x:c,ease:Cubic.easeInOut}),TweenMax.to($(".submenu.first"),1,{x:c,autoAlpha:0,ease:Cubic.easeInOut,onComplete:function(){$(".submenu.first").attr("data-current")!==a&&void 0!==a&&(o(a),$(".main a[data-trigger='"+a+"']").addClass("active"),n())}}))}function q(){if($(".slider-nav").length&&(window.mobilecheck()||$(window).width()<767)){var a=window.innerHeight;window.headHeight=a,TweenMax.to(".slider-nav",.5,{height:a,ease:Cubic.easeOut})}}var r=/^((?!chrome|android).)*safari/i.test(navigator.userAgent);if(window.ie=a(),$(".slider-nav").length){TweenMax.lagSmoothing(400,10);var s=$("#content").smoothState().data("smoothState");$("p:empty").remove();var t=$(".slider-nav>.slider-wrapper>.slides"),u=($(".slider-nav .captions-full ul"),$(".overlay-menu"),$(".slider-nav>.slider-wrapper")),v=($(".view-toggle"),$("body").attr("data-domain")),w=!1;TweenMax.set(".slider-nav>.slider-wrapper",{scale:1,opacity:1,force3D:"auto"});var x=.0101,y=.18;t.flickity({initialIndex:0,draggable:!1,autoPlay:!1,pauseAutoPlayOnHover:!0,pageDots:!1,prevNextButtons:!1,selectedAttraction:x,friction:y,dragThreshold:10,sync:".captions-full ul"}),$(".captions-full ul").on("ready.flickity",function(){TweenMax.set($(".captions-full"),{autoAlpha:0}),TweenMax.set($(".captions-full .is-selected").find("h4"),{autoAlpha:0}),TweenMax.set($(".captions-full .is-selected").find(".subtitle"),{autoAlpha:0}),TweenMax.set($(".captions-full .is-selected").find("p"),{autoAlpha:0}),$(window).width()<767&&TweenMax.set($(".captions-full .is-selected").find(".seo-title"),{autoAlpha:0}),$(".captions-full .is-selected").find("p").css("visibility","hidden"),setTimeout(function(){E&&(TweenMax.set($(".captions-full"),{autoAlpha:0}),TweenMax.set($(".captions-full .is-selected").find("h4"),{autoAlpha:0}),TweenMax.set($(".captions-full .is-selected").find(".subtitle"),{autoAlpha:0}),TweenMax.set($(".captions-full .is-selected").find("p"),{autoAlpha:0}),$(window).width()<767&&TweenMax.set($(".captions-full .is-selected").find(".seo-title"),{autoAlpha:0}),TweenMax.to($(".captions-full"),.5,{autoAlpha:1,delay:.5,onComplete:function(){var a=$(".captions-full ul .is-selected");if(w=!0,window.zoomEffect(),TweenMax.fromTo(a.find(".subtitle"),1,{autoAlpha:0},{autoAlpha:1,delay:.1,ease:Cubic.easeOut}),TweenMax.fromTo(a.find("h4"),5,{autoAlpha:0},{autoAlpha:1,delay:.5,ease:Cubic.easeOut}),$(window).width()<767&&TweenMax.fromTo(a.find(".seo-title"),5,{autoAlpha:0},{autoAlpha:.5,delay:.7,ease:Cubic.easeOut}),a.find("p").length){var b=new SplitText(a.find("p"),{type:"chars,words,lines"});TweenMax.staggerFrom(b.words,2,{autoAlpha:0,ease:Cubic.easeOut,delay:.5,onStart:function(){TweenMax.set($(".captions-full p"),{autoAlpha:1}),$(".captions-full p").css("visibility","visible")},onComplete:function(){a.find(".loadpage").addClass("in").css("visibility","visible")}},.04)}else TweenMax.to($(".captions-full .is-selected").find("h4"),5,{autoAlpha:1,delay:.5,ease:Cubic.easeOut,onComplete:function(){a.find(".loadpage").length&&a.find(".loadpage").addClass("in").css("visibility","visible")}}),"hidden"!==$(".captions-full").css("visibility")?(TweenMax.to($(".captions-full .is-selected").find(".subtitle"),1,{autoAlpha:1,delay:.1,ease:Cubic.easeOut}),$(".captions-full p").css({visibility:"visible",opacity:1}),$(".captions-full ul li.is-selected").find("button").addClass("in").css("visibility","visible")):TweenMax.to($(".captions-full .is-selected").find(".subtitle"),1,{autoAlpha:1,delay:.6,ease:Cubic.easeOut})}}))},100)}),$(".captions-full ul").flickity({draggable:!1,autoPlay:!1,initialIndex:0,pageDots:!1,prevNextButtons:!1,selectedAttraction:x,friction:y,dragThreshold:10}),window.mobilecheck=function(){var a=!1;return function(b){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|Android|BlackBerry|iPhone|iPad|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(b)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(b.substr(0,4)))&&(a=!0)}(navigator.userAgent||navigator.vendor||window.opera),a};var z=document.getElementById("sliderNav"),A=new Hammer(z);window.mobilecheck()&&(A.on("swipeleft",function(a){$(".slider-nav>.slider-wrapper").hasClass("zoomed-out")||(t.flickity("next"),null!==window.countDown&&void 0!==window.countDown&&window.countDown.pause(0))}),A.on("swiperight",function(a){$(".slider-nav>.slider-wrapper").hasClass("zoomed-out")||(t.flickity("previous"),null!==window.countDown&&void 0!==window.countDown&&window.countDown.pause(0))})),window.headHeight=$(window).height();var B=t.find(".background"),C=t.data("flickity");Draggable.create($(".progress-bar"),{type:"x",overshootTolerance:0,edgeResistance:.65,bounds:$(".progress"),throwProps:!0,onDrag:function(){var a=f(this.endX/this.maxX,1,0),b=C.cells.length,c=Math.floor(b*a);t.flickity("select",c)}}),u.addClass("ready"),void 0!=u.find(".background").data("vide")&&u.find(".background").data("vide").getVideoObject().play();$(".navbar-toggle-overlay"),$(".overlay-menu");window.countDown=null,TweenMax.set(".countdown>.bar",{width:0}),$("body").idle({onIdle:function(){null!==window.countDown&&window.autoPlay&&window.countDown.play()},onActive:function(){null!==window.countDown&&window.countDown.pause(0)},idle:6e3,events:"mousemove mouseclick keydown keypress mousewheel click"}),$("body").click(function(){null!==window.countDown&&window.countDown.pause(0)}),$("body").mousemove(function(){null!==window.countDown&&window.countDown.pause(0)}),window.zoomEffect=function(a){a=a||0;var b=t.find(".is-selected").children(".inner").children(".background");a?window.mobilecheck()?TweenMax.to(t.find(".cell").children(".inner").children(".background"),2,{scale:1,ease:Cubic.easeOut,overwrite:"all"}):b.hasClass("video")?b.data("vide").getVideoObject().pause():TweenMax.to(t.find(".cell").children(".inner").children(".background"),2,{scale:1,ease:Cubic.easeOut,overwrite:"all"}):(t.find(".cell").not(".is-selected").each(function(){TweenMax.set($(this).children(".inner").children(".background"),{scale:1}),!window.mobilecheck()&&$(this).find(".background.video").hasClass("video")&&$(this).find(".background.video").data("vide").getVideoObject().pause()}),window.mobilecheck()?TweenMax.to(b,30,{scale:1.2,delay:.5,ease:Cubic.easeOut}):b.hasClass("video")?b.data("vide").getVideoObject().play():TweenMax.to(b,30,{scale:1.2,delay:.5,ease:Cubic.easeOut}))};var D=!0;t.on("settle.flickity",function(){D=!0,s.fetch(t.find(".is-selected").children(".inner").attr("data-link")),$(".slider-nav>.slider-wrapper").hasClass("zoomed-out")||(window.zoomEffect(),$(".captions-full ul li").not(".is-selected").find("button").removeClass("in").css("visibility","hidden"),$(".captions-full ul li.is-selected").find("button").addClass("in").css("visibility","visible"))}),t.on("select.flickity",function(){var a=parseInt(C.selectedIndex+1),b=parseInt(C.slides.length);a>1?$(".slider-nav .back").not(".arrow").css("display","block"):$(".slider-nav .back").not(".arrow").css("display","none"),a<b?$(".slider-nav .next").not(".arrow").css("display","block"):$(".slider-nav .next").not(".arrow").css("display","none"),null!==window.countDown&&window.countDown.pause(0),$(".section-wrap .current").text()!==t.find(".is-selected").attr("data-section")&&TweenMax.to(".section-wrap .current",.5,{autoAlpha:0,ease:Cubic.easeOut,onComplete:function(){t.find(".is-selected").attr("data-section")?(TweenMax.to(".section-wrap .inner",.5,{autoAlpha:1}),$(".section-wrap .current").text(t.find(".is-selected").attr("data-section"))):($(".section-wrap .current").empty(),TweenMax.to(".section-wrap .inner",.5,{autoAlpha:0})),TweenMax.to(".section-wrap .current",.5,{autoAlpha:1,ease:Cubic.easeOut})}})}),t.on("dragStart.flickity",function(){D=!1,window.mobilecheck()||$.pnp.disableScroll(),$("html,body").scrollTop(0)}),t.on("dragMove.flickity",function(){D=!1}),t.on("dragEnd.flickity",function(){D=!1}),t.on("scroll.flickity",function(a,b){r||window.mobilecheck()||window.ie||e(),d(b)});var E=!1;$(".slides li").each(function(a){var b=$(this),c=a;if(window.mobilecheck()&&$(window).width()<768){var d=b.find(".background");d.css("background-image","url("+d.attr("data-mobile")+")")}b.click(function(c){c.preventDefault(),null!==window.countDown&&window.countDown.pause(0),D&&u.hasClass("zoomed-out")&&(b.hasClass("is-selected")&&j(),t.flickity("select",a,!1,!1))});var e=$(this).find(".background"),f=e.attr("data-video"),i=e.attr("data-poster");""===f||void 0===f||window.mobilecheck()||$(this).find(".background").vide({mp4:f,poster:i},{volume:0,playbackRate:1,muted:!0,loop:!0,autoplay:!1,position:"0% 50%",posterType:"jpg",resizing:!0,bgColor:"#000000",className:""});var k=h(b.children(".inner").attr("data-link"));window.location.href.indexOf(k)>-1&&"/"!==k&&k!==v?(t.flickity("select",c,!1,!0),$(".captions-full ul").flickity("select",c,!1,!0),E=!0,b.hasClass("sub-slide")):h(window.location.href)===v&&(E=!0,window.autoPlay=!0,g(),t.flickity("select",0,!1,!0)),void 0!=b.find(".background").data("vide")&&b.find(".background").data("vide").getVideoObject().play()}),E?l():$(".sub-slide").length&&k(!0),$(".next, .back").on("mousemove",function(a){var b=a,c=$(this),d=c.find(".cursor"),e=b.clientX-c.offset().left,f=b.clientY-c.offset().top;TweenMax.to(d,.2,{x:e,y:f,ease:Cubic.easeOut})}),$(".next").click(function(){t.flickity("next"),$.pnp.disableScroll(),$("html,body").scrollTop(0),null!==window.countDown&&window.countDown.pause(0)}),$(".back").click(function(){t.flickity("previous"),$.pnp.disableScroll(),$("html,body").scrollTop(0),null!==window.countDown&&window.countDown.pause(0)}),$document.on("click",".navbar-toggle-overlay",function(){var a=$(this),d=$(".overlay-menu");d.is(":visible")?(a.removeClass("active"),d.fadeOut(),c(),$(".nav-container .image, .view-toggle").removeClass("white"),$(".project").removeClass("hidden")):(a.addClass("active"),d.fadeIn(),b(),$(".project").addClass("hidden"),$(".nav-container .image, .view-toggle").addClass("white"))}),$(".captions-full ul li").each(function(){function a(){b.hasClass("active")&&"auto_next"===b.attr("data-transition")?setTimeout(function(){t.flickity("next")},500):b.hasClass("direct")?location.href=b.children(".inner").attr("data-link"):i(b.children(".inner").attr("data-link")),b.hasClass("extended")&&localStorage.setItem("autoPlay","true")}var b=$(this);b.find(".caption button").append('<div class="left">'),b.find(".caption button").append('<div class="top">'),b.find(".caption button").append('<div class="right">'),b.find(".caption button").append('<div class="bottom">'),$(window).width()<767&&b.find(".seo-title").insertAfter($(this).find("h4")),b.find("button").click(function(){a(),window.autoPlay=!1})}),$(".view-toggle").click(function(){u.hasClass("zoomed-out")?j():k(),$(".overlay-menu").is(":visible")&&($(".navbar-toggle-overlay").removeClass("active"),$(".overlay-menu").fadeOut())})}else setTimeout(function(){$(".contact").length&&!$(".nav-container").hasClass("black")&&($(".nav-container").removeClass("white"),$(".nav-container").addClass("black"),$(window).width()<768&&$(".nav-container").addClass("full-background"))},10),$document.on("click",".navbar-toggle-overlay",function(){var a=$(this),d=$(".overlay-menu");d.is(":visible")?(a.removeClass("active"),c(),d.fadeOut(),p()):(a.addClass("active"),b(),d.fadeIn())});TweenMax.set($(".side-menu-container .main, .submenu"),{x:"100%"}),TweenMax.set($(".submenu"),{autoAlpha:0}),$(".submenu.first .back").click(function(){$("#side-menu-container, #desktop-nav").removeClass("expanded"),TweenMax.to(".submenu.first",1,{x:"100%",autoAlpha:0,ease:Cubic.easeInOut,overwrite:"all"}),TweenMax.to(".main.menu-wrapper, .submenu.second",1,{x:"100%",autoAlpha:1,ease:Cubic.easeInOut,onComplete:function(){n()}})}),$(".submenu.second .back").click(function(){$("#side-menu-container, #desktop-nav").removeClass("extended"),TweenMax.to(".submenu.second",1,{x:"50%",autoAlpha:0,ease:Cubic.easeInOut,overwrite:"all"}),TweenMax.to(".main.menu-wrapper, .submenu.first",1,{x:"50%",autoAlpha:1,ease:Cubic.easeInOut,onComplete:function(){n()}})});$(".side-menu-container a").each(function(){$(this).click(function(){$(this).hasClass("portfolio")?(window.autoPlay=!0,localStorage.setItem("autoPlay","true")):(window.autoPlay=!1,localStorage.setItem("autoPlay","false"))})}),$(".side-menu-container .main>ul>li").each(function(a){var b=$(this),c=b.find(".first-level"),d=(c.find("li"),b.find(".parent>a"));$(".main.menu-wrapper");b.hover(function(){d.hasClass("active")||TweenMax.to(d,.5,{autoAlpha:1})},function(){d.hasClass("active")||TweenMax.to(d,.5,{autoAlpha:.5})}),b.find(".parent").hasClass("has-children")&&d.click(function(a){a.preventDefault(),$(".main, .first-level").find(".active").removeClass("active"),d.addClass("active"),o(d.attr("data-trigger")),n()})}),$(".first-level li").each(function(){var a=$(this),b=a.find("a");a.parent().parent().find(".parent").find("a"),$(".main.menu-wrapper");a.hover(function(){b.hasClass("active")||TweenMax.to(b,.5,{autoAlpha:1})},function(){b.hasClass("active")||TweenMax.to(b,.5,{autoAlpha:.5})}),void 0!==b.attr("data-trigger")&&b.click(function(a){a.preventDefault(),$(".first-level").find(".active").removeClass("active"),b.addClass("active"),o(b.attr("data-trigger"),2),n()})}),$(window).scroll(function(){$(".slider-nav").length&&($(window).scrollTop()>$(".slider-nav").offset().top+$(".slider-nav").height()&&(null!==window.countDown&&void 0!==window.countDown&&window.countDown.pause(0),window.autoPlay=!1),"none"===$(".mm-overlay").css("display")&&($(window).width()<768&&$(window).scrollTop()>$(".slider-nav").offset().top+$(".slider-nav").height()-65?$(".nav-container").addClass("full-background"):$(".nav-container").removeClass("full-background")),$(window).scrollTop()<window.headHeight&&$(".nav-container").hasClass("black")&&$(".nav-container").removeClass("black"))}),$(window).resize(function(){q()}),q()}),$.pnp.initSliders=function(){if($(".slider-container").length){if(pnpHelper.dependencyCheck.requireDependencies("Slider",[pnpHelper.dependencyCheck.slickSlider]))return;$(".slider-container:visible:not(.slick-initialized)").each(function(){function a(a){return $.extend({infinite:!0,mobileFirst:!1,speed:400},a)}var b=$(this).data("pnp-slider-config");$(this).slick(a(b))})}},$.pnp.initSubNav=function(){$.fn.anchorPointBar=function(a,b){var c=this,d=$(this),e=d.find("ul"),f=0,g=!1,h=0,i=0,j=0,k={elemSelector:"[data-pnp-apb-anchor]",stickToNav:!0,replaceNav:!1,scrollDuration:1e3,responsiveWidth:767};a&&$.extend(k,a),d.closest("[data-pnp-search-results]").length>0&&0==d.closest("[data-pnp-search-results]").find(".anchor-component").length&&(k.elemSelector="[data-pnp-search-results] h2"),this.addAnchorPoint=function(a,b){var c="";void 0===b&&(b=""),0==f&&(c="active");var d=a.data("pnp-apb-anchor");null!=d&&0!=d.length||(d=a.text()),e.append('<li class="'+c+'" data-pnp-apb-anchor-index="'+f+'"><a href="#" class="nav-line-height '+b+'">'+d+"</a></li>"),f++},this.init=function(){function a(){$window.width()>k.responsiveWidth&&($window.scrollTop()>=f?m.addClass("-fixed"):m.removeClass("-fixed"))}if(!$.fn.viewportChecker)return void console.error("MISSING DEPENDENCY: The component 'anchor-point-bar' requires the library 'jquery-viewport-checker'. Please update packages.json to include this library.");if(b||($(k.elemSelector).each(function(a){$(this).attr("data-pnp-apb-index",a)}),$document.on("click",".anchor-points a",function(){if(!g){var a=$(this).closest("[data-pnp-apb-anchor-index]").data("pnp-apb-anchor-index");if(g=!0,$('[data-pnp-apb-index="'+a+'"]').length){var b=$('[data-pnp-apb-index="'+a+'"]').offset().top;b-=d.outerHeight(),k.stickToNav&&(b-=pnpHelper.getNavHeight()),$("html, body").animate({scrollTop:b+"px"},k.scrollDuration,function(){g=!1,h=0,i=0,j=0})}}return!1})),!c.hasClass("-vertical")&&(k.stickToNav||k.replaceNav)){var e,f=d.offset().top,l=k.replaceNav?0:pnpHelper.getNavHeight(),m=d.find(".inner");k.stickToNav&&(f-=pnpHelper.getNavHeight()),a(),$window.scroll(a).resize(function(){$window.width()>k.responsiveWidth&&(clearTimeout(e),e=setTimeout(function(){f=d.offset().top,k.stickToNav&&(f-=$navBar.height()),l=k.stickToNav?$navBar.height():0},300))})}},0==e.find("[data-pnp-apb-anchor-index]").length&&(c.init(),b||$(k.elemSelector).each(function(a){c.addAnchorPoint($(this))}))},$(".component-subnav.-internal").length>0&&$(".component-subnav.-internal").anchorPointBar(null,!1),$(".component-subnav.-external").length>0&&$(".component-subnav.-external").anchorPointBar(null,!0),$("[data-pnp-apb-index]").viewportChecker({repeat:!0,callbackFunction:function(a,b){var c=$("[data-pnp-apb-anchor-index]").eq($(a).data("pnp-apb-index"));"add"==b?c.addClass("active"):c.removeClass("active")}})},$.pnp.initTeam=function(){$(".component-team").length&&(console.log("found team component!"),$(".component-team .profile").each(function(){var a=$(this),b=a.attr("data-name"),c=a.attr("data-position"),d=a.attr("data-img"),e='<img src="'+d+'"/>'+a.attr("data-content");a.attr("data-trigger")&&a.click(function(){console.log("click!"),$.pnp.overlayer.populate(b,c,e,!1),$.pnp.overlayer.show()})}))};
;(function($){
  $(document).on("click", "button.loadpage, .caption button", function(e){
    var $btn = $(this);
    var $li = $btn.closest("li.cell");
    var link = $btn.attr("data-link") || ($li.length ? $li.find(".inner").attr("data-link") : "");
    var curP = window.location.pathname.replace(/\/index\.html$/, "").replace(/\/$/, "");
    var tarP = (link || "").replace(window.location.origin, "").replace(/\/index\.html$/, "").replace(/\/$/, "");
    if (!link || link === "#" || link === "/" || tarP === curP || link === window.location.href) {
      if (e) e.preventDefault();
      var d = $(window).width() < 767 ? ($(window).height() - 57) : $(window).height();
      if (typeof window.headHeight === "number" && window.headHeight > 0) {
        d = $(window).width() < 767 ? (window.headHeight - 57) : window.headHeight;
      }
      if ($.pnp && $.pnp.enableScroll) $.pnp.enableScroll();
      $("html, body").stop().animate({ scrollTop: d }, 700);
      if (typeof TweenMax !== "undefined") {
        TweenMax.to(window, 0.7, { scrollTo: { y: d, autoKill: false }, ease: Cubic.easeInOut, onComplete: function() {
          if ($.pnp && $.pnp.enableScroll) $.pnp.enableScroll();
        }});
      }
    }
